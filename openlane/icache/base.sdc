...
set_input_delay -max 2.0000 -clock [get_clocks {i_clk}] -add_delay [get_ports {wb_ack}]
set_input_delay -max 2.0000 -clock [get_clocks {i_clk}] -add_delay [get_ports {wb_err}]

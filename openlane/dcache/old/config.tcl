...
set ::env(VERILOG_FILES_BLACKBOX) "\
	$script_dir/../../verilog/rtl/dcache_ram.v"

set ::env(EXTRA_LEFS) "\
	$script_dir/../../lef/dcache_ram.lef"

set ::env(EXTRA_GDS_FILES) "\
	$script_dir/../../gds/dcache_ram.gds"
...
set ::env(DIE_AREA) "0 0 1000 1900"
...
set ::env(FP_PDN_MACRO_HOOKS) "\
	mem_set_0 vccd1 vssd1 vccd1 vssd1,\
	mem_set_1 vccd1 vssd1 vccd1 vssd1"

module core (i_clk,
 ...
 sky130_fd_sc_hd__dfxtp_1 _7919_ (.CLK(clknet_leaf_75_i_clk),
    .D(_0150_),
    .Q(\decode.oc_rf_ie[7] ));
 sky130_fd_sc_hd__dfxtp_2 _7920_ (.CLK(clknet_leaf_6_i_clk),
    .D(_0151_),
    .Q(\decode.oc_l_reg_sel[0] ));
 sky130_fd_sc_hd__dfxtp_1 _7921_ (.CLK(clknet_leaf_0_i_clk),
    .D(_0152_),
    .Q(\decode.oc_l_reg_sel[1] ));
 sky130_fd_sc_hd__dfxtp_2 _7922_ (.CLK(clknet_leaf_6_i_clk),
    .D(_0153_),

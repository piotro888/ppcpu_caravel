module core (i_clk,
 ...
 sky130_fd_sc_hd__clkinv_4 _3845_ (.A(_0502_),
    .Y(net104));
 sky130_fd_sc_hd__buf_2 _3846_ (.A(\decode.oc_r_reg_sel[2] ),
    .X(_0503_));
 sky130_fd_sc_hd__buf_2 _3847_ (.A(_0503_),
    .X(_0504_));
 sky130_fd_sc_hd__buf_2 _3848_ (.A(\decode.oc_r_reg_sel[0] ),
    .X(_0505_));
 sky130_fd_sc_hd__clkbuf_2 _3849_ (.A(_0505_),
    .X(_0506_));
 sky130_fd_sc_hd__buf_2 _3850_ (.A(\decode.oc_r_reg_sel[1] ),
    .X(_0507_));
 sky130_fd_sc_hd__clkbuf_2 _3851_ (.A(_0507_),
    .X(_0508_));
 sky130_fd_sc_hd__or3_4 _3852_ (.A(_0504_),
    .B(_0506_),
    .C(_0508_),
    .X(_0509_));
 sky130_fd_sc_hd__buf_8 _3853_ (.A(_0509_),
    .X(_0510_));
 ...
 sky130_fd_sc_hd__a22o_1 _3858_ (.A1(\execute.rf.reg_outputs[7][15] ),
    ...
    .X(_0515_));
 sky130_fd_sc_hd__nor3b_1 _3859_ (.A(_0503_),
    .B(_0507_),
    .C_N(_0505_),
    .Y(_0516_));
 sky130_fd_sc_hd__buf_4 _3860_ (.A(_0516_),
    .X(_0517_));
 ...
 sky130_fd_sc_hd__nor3b_4 _3869_ (.A(_0503_),
    ...
    .C_N(_0507_),
    .Y(_0526_));
 sky130_fd_sc_hd__buf_2 _3870_ (.A(_0505_),
    .X(_0527_));
 sky130_fd_sc_hd__buf_2 _3871_ (.A(_0527_),
    .X(_0528_));
 sky130_fd_sc_hd__clkbuf_4 _3872_ (.A(_0528_),
    .X(_0529_));
 sky130_fd_sc_hd__buf_2 _3873_ (.A(_0507_),
    .X(_0530_));
 sky130_fd_sc_hd__buf_2 _3874_ (.A(_0530_),
    .X(_0531_));
 sky130_fd_sc_hd__buf_2 _3875_ (.A(_0531_),
    .X(_0532_));
 ...
 sky130_fd_sc_hd__buf_2 _3912_ (.A(_0503_),
    .X(_0565_));
 sky130_fd_sc_hd__clkbuf_4 _3913_ (.A(\decode.oc_r_reg_sel[0] ),
    .X(_0566_));
 sky130_fd_sc_hd__buf_2 _3914_ (.A(_0566_),
    .X(_0567_));
 sky130_fd_sc_hd__buf_2 _3915_ (.A(\decode.oc_r_reg_sel[1] ),
    .X(_0568_));
 sky130_fd_sc_hd__buf_2 _3916_ (.A(_0568_),
    .X(_0569_));
 ...
 sky130_fd_sc_hd__o32ai_4 _3921_ (.A1(_0563_),
    ...
    .B2(net130),
    .Y(_0574_));
 sky130_fd_sc_hd__inv_2 _3922_ (.A(_0574_),
    .Y(net236));
 ...
 sky130_fd_sc_hd__and4b_1 _3927_ (.A_N(_0568_),
    ...
    .X(_0579_));
 sky130_fd_sc_hd__buf_2 _3928_ (.A(_0503_),
    .X(_0580_));
 ...
 sky130_fd_sc_hd__o32ai_4 _3931_ (.A1(_0576_),
    ...
    .B2(net129),
    .Y(_0583_));
 sky130_fd_sc_hd__clkinv_4 _3932_ (.A(_0583_),
    .Y(net235));
 ...
 sky130_fd_sc_hd__and4bb_1 _3968_ (.A_N(_0527_),
    ...
    .D(_0580_),
    .X(_0616_));
 sky130_fd_sc_hd__a2111oi_2 _3969_ (.A1(\execute.rf.reg_outputs[5][6] ),
    .A2(_0525_),
    .B1(_0615_),
    .C1(_0616_),
    .D1(_0593_),
 ...
 sky130_fd_sc_hd__o32ai_4 _3989_ (.A1(_0628_),
    ...
    .B2(net138),
    .Y(_0635_));
 sky130_fd_sc_hd__clkinv_4 _3990_ (.A(_0635_),
    .Y(net244));
 ...
 sky130_fd_sc_hd__o22ai_4 _3997_ (.A1(net137),
    ...
    .B2(_0641_),
    .Y(_0642_));
 sky130_fd_sc_hd__inv_2 _3998_ (.A(_0642_),
    .Y(net243));
 ...
 sky130_fd_sc_hd__o32ai_4 _4004_ (.A1(_0644_),
    ...
    .B2(net136),
    .Y(_0648_));
 sky130_fd_sc_hd__inv_6 _4005_ (.A(_0648_),
    .Y(net242));
 ...
 sky130_fd_sc_hd__clkbuf_4 _4058_ (.A(\decode.oc_l_reg_sel[1] ),
    .X(_0699_));
 sky130_fd_sc_hd__clkbuf_4 _4059_ (.A(_0699_),
    .X(_0700_));
 sky130_fd_sc_hd__buf_2 _4060_ (.A(\decode.oc_l_reg_sel[0] ),
    .X(_0701_));
 sky130_fd_sc_hd__clkbuf_4 _4061_ (.A(_0701_),
    .X(_0702_));
 ...
 sky130_fd_sc_hd__and3_4 _4069_ (.A(_0709_),
    ...
    .C(_0701_),
    .X(_0710_));
 sky130_fd_sc_hd__clkbuf_4 _4070_ (.A(\decode.oc_l_reg_sel[1] ),
    .X(_0711_));
 sky130_fd_sc_hd__buf_2 _4071_ (.A(_0711_),
    .X(_0712_));
 ...
 sky130_fd_sc_hd__o211a_1 _4619_ (.A1(\execute.sreg_long_ptr_en ),
    ...
    .C1(_1161_),
    .X(_0017_));
 sky130_fd_sc_hd__nand2_1 _4620_ (.A(_0635_),
    .B(_1174_),
    .Y(_1176_));
 ...
 sky130_fd_sc_hd__o211a_1 _4637_ (.A1(\execute.sreg_priv_control.o_d[8] ),
    ...
    .C1(_1161_),
    .X(_0022_));
 sky130_fd_sc_hd__nand2_1 _4638_ (.A(_0591_),
    .B(_1174_),
    .Y(_1189_));
 sky130_fd_sc_hd__o211a_1 _4639_ (.A1(\execute.sreg_priv_control.o_d[9] ),
    ...
    .C1(_1161_),
    .X(_0023_));
 sky130_fd_sc_hd__nand2_1 _4640_ (.A(_0583_),
    .B(_1174_),
    .Y(_1190_));
 sky130_fd_sc_hd__o211a_1 _4641_ (.A1(\execute.sreg_priv_control.o_d[10] ),
    ...
    .C1(_1161_),
    .X(_0024_));
 sky130_fd_sc_hd__nand2_1 _4642_ (.A(_0574_),
    .B(_1174_),
    .Y(_1191_));
 ...
 sky130_fd_sc_hd__inv_6 _4848_ (.A(\decode.oc_r_bus_imm ),
    .Y(_1305_));
 sky130_fd_sc_hd__mux2_2 _4849_ (.A0(net231),
    .A1(net247),
    .S(_1305_),
    .X(_1306_));
 ...
 sky130_fd_sc_hd__inv_2 _4879_ (.A(_1335_),
    .Y(_1336_));
 sky130_fd_sc_hd__and4bb_1 _4880_ (.A_N(_1318_),
    .B_N(_1329_),
    .C(_1332_),
    .D(_1336_),
    .X(_1337_));
 ...
 sky130_fd_sc_hd__xnor2_1 _4917_ (.A(\execute.alu_mul_div.div_cur[0] ),
    .B(_1349_),
    .Y(_1374_));
 sky130_fd_sc_hd__clkbuf_2 _4918_ (.A(\decode.oc_l_reg_sel[2] ),
    .X(_1375_));
 sky130_fd_sc_hd__or3_2 _4919_ (.A(_1375_),
    .B(_0699_),
    .C(_0701_),
    .X(_1376_));
 sky130_fd_sc_hd__buf_6 _4920_ (.A(_1376_),
    .X(_1377_));
 ...
 sky130_fd_sc_hd__a221o_1 _4928_ (.A1(\execute.rf.reg_outputs[6][10] ),
    ...
    .C1(_1384_),
    .X(_1385_));
 sky130_fd_sc_hd__nor3b_4 _4929_ (.A(\decode.oc_l_reg_sel[2] ),
    .B(\decode.oc_l_reg_sel[0] ),
    .C_N(_0711_),
    .Y(_1386_));
 sky130_fd_sc_hd__buf_4 _4930_ (.A(_1386_),
    .X(_1387_));
 sky130_fd_sc_hd__and3b_1 _4931_ (.A_N(\decode.oc_l_reg_sel[2] ),
    .B(_0711_),
 ...
 sky130_fd_sc_hd__nand2_1 _5101_ (.A(_1350_),
    .B(_1351_),
    .Y(_1554_));
 sky130_fd_sc_hd__buf_4 _5102_ (.A(_1554_),
    .X(_1555_));
 ...
 sky130_fd_sc_hd__a21oi_4 _5105_ (.A1(\decode.oc_alu_mode[12] ),
    ...
    .B1(_1557_),
    .Y(_1558_));
 sky130_fd_sc_hd__clkbuf_4 _5106_ (.A(_1558_),
    .X(_1559_));
 ...
 sky130_fd_sc_hd__mux2_1 _5166_ (.A0(_1607_),
    ...
    .S(_1362_),
    .X(_1619_));
 sky130_fd_sc_hd__mux2_1 _5167_ (.A0(net226),
    .A1(net242),
    .S(_1305_),
    .X(_1620_));
 sky130_fd_sc_hd__clkbuf_4 _5168_ (.A(_1620_),
    .X(_1621_));
 ...
 sky130_fd_sc_hd__nor2_1 _5170_ (.A(_1622_),
    .B(_1599_),
    .Y(_1623_));
 sky130_fd_sc_hd__a211o_2 _5171_ (.A1(net135),
    .A2(_1416_),
    .B1(_1474_),
    .C1(_1478_),
    .X(_1624_));
 ...
 sky130_fd_sc_hd__o211a_1 _5354_ (.A1(\execute.pc_high_buff_out[1] ),
    ...
    .C1(_1651_),
    .X(_0176_));
 sky130_fd_sc_hd__mux2_1 _5355_ (.A0(_0648_),
    .A1(_0678_),
    .S(_1748_),
    .X(_1753_));
 ...
 sky130_fd_sc_hd__o21ba_1 _5360_ (.A1(\execute.pc_high_buff_out[3] ),
    ...
    .B1_N(_1756_),
    .X(_0178_));
 sky130_fd_sc_hd__mux2_1 _5361_ (.A0(_0635_),
    .A1(_0684_),
    .S(_1748_),
    .X(_1757_));
 ...
 sky130_fd_sc_hd__o211a_1 _5369_ (.A1(\execute.pc_high_buff_out[6] ),
    ...
    .C1(_1651_),
    .X(_0181_));
 sky130_fd_sc_hd__nor2_1 _5370_ (.A(_0609_),
    .B(_1748_),
    .Y(_1763_));
 ...
 sky130_fd_sc_hd__mux2_1 _5430_ (.A0(\execute.pc_high_buff_out[7] ),
    ...
    .S(_1775_),
    .X(_1815_));
 sky130_fd_sc_hd__nand2_1 _5431_ (.A(_0609_),
    .B(_1774_),
    .Y(_1816_));
 ...
 sky130_fd_sc_hd__o21a_1 _5453_ (.A1(\execute.sreg_scratch.o_d[1] ),
    ...
    .B1(_1830_),
    .X(_0197_));
 sky130_fd_sc_hd__a21oi_1 _5454_ (.A1(_0648_),
    .A2(_1828_),
    .B1(_1818_),
    .Y(_1831_));
 ...
 sky130_fd_sc_hd__clkbuf_4 _5459_ (.A(net75),
    .X(_1834_));
 sky130_fd_sc_hd__a21oi_1 _5460_ (.A1(_0635_),
    .A2(_1833_),
    .B1(_1834_),
    .Y(_1835_));
 ...
 sky130_fd_sc_hd__o21a_1 _5465_ (.A1(\execute.sreg_scratch.o_d[6] ),
    ...
    .B1(_1837_),
    .X(_0202_));
 sky130_fd_sc_hd__a21oi_1 _5466_ (.A1(_0609_),
    .A2(_1833_),
    .B1(_1834_),
    .Y(_1838_));
 ...
 sky130_fd_sc_hd__o21a_1 _5469_ (.A1(\execute.sreg_scratch.o_d[8] ),
    ...
    .B1(_1839_),
    .X(_0204_));
 sky130_fd_sc_hd__a21oi_1 _5470_ (.A1(_0591_),
    .A2(_1833_),
    .B1(_1834_),
    .Y(_1840_));
 sky130_fd_sc_hd__o21a_1 _5471_ (.A1(\execute.sreg_scratch.o_d[9] ),
    ...
    .B1(_1840_),
    .X(_0205_));
 sky130_fd_sc_hd__a21oi_1 _5472_ (.A1(_0583_),
    .A2(_1833_),
    .B1(_1834_),
    .Y(_1841_));
 sky130_fd_sc_hd__o21a_1 _5473_ (.A1(\execute.sreg_scratch.o_d[10] ),
    ...
    .B1(_1841_),
    .X(_0206_));
 sky130_fd_sc_hd__a21oi_1 _5474_ (.A1(_0574_),
    .A2(_1833_),
    .B1(_1834_),
    .Y(_1842_));
 ...
 sky130_fd_sc_hd__mux2_1 _5521_ (.A0(net85),
    ...
    .S(_1821_),
    .X(_1876_));
 sky130_fd_sc_hd__nor2_1 _5522_ (.A(_0648_),
    .B(_1872_),
    .Y(_1877_));
 ...
 sky130_fd_sc_hd__mux2_1 _5529_ (.A0(net88),
    ...
    .S(_1821_),
    .X(_1882_));
 sky130_fd_sc_hd__nor2_1 _5530_ (.A(_0635_),
    .B(_1872_),
    .Y(_1883_));
 ...
 sky130_fd_sc_hd__mux2_1 _5542_ (.A0(net91),
    ...
    .S(_1821_),
    .X(_1892_));
 sky130_fd_sc_hd__nor2_1 _5543_ (.A(_0609_),
    .B(_1889_),
    .Y(_1893_));
 ...
 sky130_fd_sc_hd__mux2_1 _5552_ (.A0(net93),
    ...
    .S(_1821_),
    .X(_1900_));
 sky130_fd_sc_hd__nor2_1 _5553_ (.A(_0591_),
    .B(_1889_),
    .Y(_1901_));
 ...
 sky130_fd_sc_hd__mux2_1 _5556_ (.A0(net94),
    ...
    .S(net41),
    .X(_1903_));
 sky130_fd_sc_hd__nor2_1 _5557_ (.A(_0583_),
    .B(_1889_),
    .Y(_1904_));
 ...
 sky130_fd_sc_hd__o32ai_4 _5614_ (.A1(_1396_),
    ...
    .B2(net142),
    .Y(_1955_));
 sky130_fd_sc_hd__nor2_1 _5615_ (.A(_1955_),
    .B(_1358_),
    .Y(_1956_));
 ...
 sky130_fd_sc_hd__a21o_1 _5630_ (.A1(_1311_),
    ...
    .B1(_1308_),
    .X(_1971_));
 sky130_fd_sc_hd__or4_1 _5631_ (.A(_1479_),
    .B(_1468_),
    .C(_1332_),
    .D(_1971_),
    .X(_1972_));
 ...
 sky130_fd_sc_hd__mux2_4 _5648_ (.A0(_1988_),
    ...
    .S(_1305_),
    .X(_1989_));
 sky130_fd_sc_hd__or2_1 _5649_ (.A(_1460_),
    .B(_1989_),
    .X(_1990_));
 sky130_fd_sc_hd__and3b_1 _5650_ (.A_N(_1990_),
    .B(_1625_),
    .C(_1327_),
    .X(_1991_));
 ...
 sky130_fd_sc_hd__or3_1 _5667_ (.A(_2001_),
    ...
    .C(_2007_),
    .X(_2008_));
 sky130_fd_sc_hd__dlymetal6s2s_1 _5668_ (.A(_2008_),
    .X(_2009_));
 ...
 sky130_fd_sc_hd__a21oi_1 _5677_ (.A1(_1984_),
    ...
    .B1(_1948_),
    .Y(_2018_));
 sky130_fd_sc_hd__or4_2 _5678_ (.A(_1985_),
    .B(_2016_),
    .C(_2017_),
    .D(_2018_),
    .X(_2019_));
 ...
 sky130_fd_sc_hd__a22o_1 _5683_ (.A1(_1420_),
    ...
    .B2(_1402_),
    .X(_2024_));
 sky130_fd_sc_hd__or4_1 _5684_ (.A(_1630_),
    .B(_1955_),
    .C(_1927_),
    .D(_1353_),
    .X(_2025_));
 ...
 sky130_fd_sc_hd__o211a_1 _5727_ (.A1(_2062_),
    ...
    .C1(_2019_),
    .X(_2068_));
 sky130_fd_sc_hd__or3_1 _5728_ (.A(_2064_),
    .B(_2067_),
    .C(_2068_),
    .X(_2069_));
 ...
 sky130_fd_sc_hd__o211a_1 _5790_ (.A1(_2076_),
    ...
    .C1(_2130_),
    .X(_2131_));
 sky130_fd_sc_hd__a211oi_1 _5791_ (.A1(_2129_),
    .A2(_2130_),
    .B1(_2076_),
    .C1(_2062_),
    .Y(_2132_));
 sky130_fd_sc_hd__nor3_1 _5792_ (.A(_2075_),
    .B(_2131_),
    .C(_2132_),
    .Y(_2133_));
 sky130_fd_sc_hd__o21a_1 _5793_ (.A1(_2131_),
    ...
    .B1(_2075_),
    .X(_2134_));
 sky130_fd_sc_hd__a211oi_1 _5794_ (.A1(_2065_),
    .A2(_2069_),
    .B1(_2133_),
    .C1(_2134_),
    .Y(_2135_));
 ...
 sky130_fd_sc_hd__xor2_1 _5832_ (.A(_2169_),
    .B(_2170_),
    .X(_2173_));
 sky130_fd_sc_hd__and3_1 _5833_ (.A(_2165_),
    .B(_2172_),
    .C(_2173_),
    .X(_2174_));
 sky130_fd_sc_hd__o22ai_1 _5834_ (.A1(_2016_),
    ...
    .B2(_1985_),
    .Y(_2175_));
 sky130_fd_sc_hd__o211a_1 _5835_ (.A1(_2171_),
    .A2(_2174_),
    .B1(_2019_),
    .C1(_2175_),
    .X(_2176_));
 sky130_fd_sc_hd__xnor2_1 _5836_ (.A(_2163_),
    .B(_2164_),
    .Y(_2177_));
 sky130_fd_sc_hd__a211oi_1 _5837_ (.A1(_2019_),
    .A2(_2175_),
    .B1(_2171_),
    .C1(_2174_),
    .Y(_2178_));
 sky130_fd_sc_hd__nor3_2 _5838_ (.A(_2176_),
    .B(_2177_),
    .C(_2178_),
    .Y(_2179_));
 ...
 sky130_fd_sc_hd__o211a_1 _5840_ (.A1(_2176_),
    ...
    .C1(_2180_),
    .X(_2181_));
 sky130_fd_sc_hd__a211oi_1 _5841_ (.A1(_2069_),
    .A2(_2180_),
    .B1(_2176_),
    .C1(_2179_),
    .Y(_2182_));
 sky130_fd_sc_hd__nor2_1 _5842_ (.A(_2181_),
    .B(_2182_),
    .Y(_2183_));
 ...
 sky130_fd_sc_hd__a22o_1 _5848_ (.A1(_1627_),
    ...
    .B2(_1515_),
    .X(_2189_));
 sky130_fd_sc_hd__or4_1 _5849_ (.A(_1993_),
    .B(_1468_),
    .C(_1926_),
    .D(_1352_),
    .X(_2190_));
 ...
 sky130_fd_sc_hd__nand3_1 _5851_ (.A(_2186_),
    ...
    .C(_2191_),
    .Y(_2192_));
 sky130_fd_sc_hd__nor2_4 _5852_ (.A(_1955_),
    .B(_1345_),
    .Y(_2193_));
 ...
 sky130_fd_sc_hd__or2_1 _5872_ (.A(_2210_),
    .B(_2212_),
    .X(_2213_));
 sky130_fd_sc_hd__nor2_1 _5873_ (.A(_1955_),
    .B(_1355_),
    .Y(_2214_));
 ...
 sky130_fd_sc_hd__o21a_1 _5885_ (.A1(_2174_),
    ...
    .B1(_2221_),
    .X(_2226_));
 sky130_fd_sc_hd__or3_2 _5886_ (.A(_2224_),
    .B(_2225_),
    .C(_2226_),
    .X(_2227_));
 sky130_fd_sc_hd__o21a_1 _5887_ (.A1(_2176_),
    ...
    .B1(_2177_),
    .X(_2228_));
 sky130_fd_sc_hd__a211oi_1 _5888_ (.A1(_2223_),
    .A2(_2227_),
    .B1(_2179_),
    .C1(_2228_),
    .Y(_2229_));
 ...
 sky130_fd_sc_hd__a21oi_2 _5900_ (.A1(_1350_),
    ...
    .B1(_1479_),
    .Y(_2241_));
 sky130_fd_sc_hd__and3_1 _5901_ (.A(_1627_),
    .B(_1316_),
    .C(_2241_),
    .X(_2242_));
 ...
 sky130_fd_sc_hd__xnor2_1 _5910_ (.A(_2248_),
    .B(_2250_),
    .Y(_2251_));
 sky130_fd_sc_hd__o32a_1 _5911_ (.A1(_1630_),
    .A2(_1356_),
    .A3(_2251_),
    .B1(_2250_),
    .B2(_2248_),
 ...
 sky130_fd_sc_hd__nor2_1 _5922_ (.A(_2261_),
    .B(_2262_),
    .Y(_2263_));
 sky130_fd_sc_hd__a211oi_2 _5923_ (.A1(_2227_),
    .A2(_2253_),
    .B1(_2259_),
    .C1(_2263_),
    .Y(_2264_));
 ...
 sky130_fd_sc_hd__a21oi_1 _5927_ (.A1(_2231_),
    ...
    .B1(_2266_),
    .Y(_2268_));
 sky130_fd_sc_hd__nor2_1 _5928_ (.A(_2267_),
    .B(_2268_),
    .Y(_2269_));
 sky130_fd_sc_hd__nor3_2 _5929_ (.A(_2265_),
    .B(_2252_),
    .C(_2264_),
    .Y(_2270_));
 ...
 sky130_fd_sc_hd__xor2_1 _5935_ (.A(_1631_),
    .B(_2275_),
    .X(_2276_));
 sky130_fd_sc_hd__xnor2_1 _5936_ (.A(_2274_),
    .B(_2276_),
    .Y(_2277_));
 sky130_fd_sc_hd__or4b_1 _5937_ (.A(_2044_),
    .B(_1358_),
    .C(_2242_),
    .D_N(_2240_),
    .X(_2278_));
 ...
 sky130_fd_sc_hd__a22o_1 _5943_ (.A1(_2241_),
    ...
    .B2(_2283_),
    .X(_2284_));
 sky130_fd_sc_hd__a21oi_1 _5944_ (.A1(_2278_),
    .A2(_2280_),
    .B1(_2284_),
    .Y(_2285_));
 sky130_fd_sc_hd__and3_1 _5945_ (.A(_2278_),
    .B(_2280_),
    .C(_2284_),
    .X(_2286_));
 sky130_fd_sc_hd__o21bai_1 _5946_ (.A1(_2277_),
    .A2(_2285_),
    .B1_N(_2286_),
    .Y(_2287_));
 sky130_fd_sc_hd__a21o_1 _5947_ (.A1(_2245_),
    ...
    .B1(_2237_),
    .X(_2288_));
 sky130_fd_sc_hd__and3_1 _5948_ (.A(_2273_),
    .B(_2287_),
    .C(_2288_),
    .X(_2289_));
 ...
 sky130_fd_sc_hd__nor2_1 _5951_ (.A(_2201_),
    .B(_2291_),
    .Y(_2292_));
 sky130_fd_sc_hd__or3b_1 _5952_ (.A(_2289_),
    .B(_2290_),
    .C_N(_2292_),
    .X(_2293_));
 sky130_fd_sc_hd__a21oi_1 _5953_ (.A1(_2248_),
    ...
    .B1(_2255_),
    .Y(_2294_));
 sky130_fd_sc_hd__nor3_1 _5954_ (.A(_2257_),
    .B(_2293_),
    .C(_2294_),
    .Y(_2295_));
 ...
 sky130_fd_sc_hd__xnor2_1 _5972_ (.A(_2282_),
    .B(_2283_),
    .Y(_2313_));
 sky130_fd_sc_hd__nand2_1 _5973_ (.A(_1508_),
    .B(_1621_),
    .Y(_2314_));
 ...
 sky130_fd_sc_hd__a21o_1 _5976_ (.A1(_2315_),
    ...
    .B1(_2316_),
    .X(_2317_));
 sky130_fd_sc_hd__xnor2_1 _5977_ (.A(_2314_),
    .B(_2317_),
    .Y(_2318_));
 ...
 sky130_fd_sc_hd__and2b_1 _5979_ (.A_N(_2318_),
    .B(_2319_),
    .X(_2320_));
 sky130_fd_sc_hd__o21ba_1 _5980_ (.A1(_2312_),
    .A2(_2313_),
    .B1_N(_2320_),
    .X(_2321_));
 sky130_fd_sc_hd__nor2_1 _5981_ (.A(_2286_),
    .B(_2285_),
    .Y(_2322_));
 sky130_fd_sc_hd__xnor2_1 _5982_ (.A(_2277_),
    .B(_2322_),
    .Y(_2323_));
 sky130_fd_sc_hd__xnor2_1 _5983_ (.A(_2321_),
    .B(_2323_),
    .Y(_2324_));
 ...
 sky130_fd_sc_hd__o21bai_1 _5985_ (.A1(_2289_),
    ...
    .B1_N(_2292_),
    .Y(_2326_));
 sky130_fd_sc_hd__nand2_1 _5986_ (.A(_2293_),
    .B(_2326_),
    .Y(_2327_));
 ...
 sky130_fd_sc_hd__xnor2_1 _5992_ (.A(_2329_),
    .B(_2332_),
    .Y(_2333_));
 sky130_fd_sc_hd__xnor2_1 _5993_ (.A(_2325_),
    .B(_2327_),
    .Y(_2334_));
 sky130_fd_sc_hd__or2_1 _5994_ (.A(_2333_),
    .B(_2334_),
    .X(_2335_));
 ...
 sky130_fd_sc_hd__xnor2_1 _6043_ (.A(_2382_),
    .B(_2383_),
    .Y(_2384_));
 sky130_fd_sc_hd__nand2_1 _6044_ (.A(_1517_),
    .B(_1562_),
    .Y(_2385_));
 ...
 sky130_fd_sc_hd__a21o_1 _6110_ (.A1(_2446_),
    ...
    .B1(_2450_),
    .X(_2451_));
 sky130_fd_sc_hd__a211oi_1 _6111_ (.A1(_2367_),
    .A2(_2366_),
    .B1(_2346_),
    .C1(_2341_),
    .Y(_2452_));
 ...
 sky130_fd_sc_hd__a311o_1 _6115_ (.A1(_2345_),
    ...
    .C1(_2343_),
    .X(_2456_));
 sky130_fd_sc_hd__xnor2_2 _6116_ (.A(_2167_),
    .B(_2183_),
    .Y(_2457_));
 sky130_fd_sc_hd__and2b_1 _6117_ (.A_N(_2229_),
    .B(_2231_),
    .X(_2458_));
 ...
 sky130_fd_sc_hd__o21ba_1 _6119_ (.A1(_2457_),
    ...
    .B1_N(_2267_),
    .X(_2460_));
 sky130_fd_sc_hd__a21oi_1 _6120_ (.A1(_2457_),
    .A2(_2458_),
    .B1(_2460_),
    .Y(_2461_));
 ...
 sky130_fd_sc_hd__nand2_1 _6246_ (.A(_1469_),
    .B(_1622_),
    .Y(_2587_));
 sky130_fd_sc_hd__and2_1 _6247_ (.A(_2385_),
    .B(_2477_),
    .X(_2588_));
 ...
 sky130_fd_sc_hd__or2_1 _6268_ (.A(_2568_),
    .B(_2608_),
    .X(_2609_));
 sky130_fd_sc_hd__a21oi_1 _6269_ (.A1(_2569_),
    .A2(_2607_),
    .B1(_2609_),
    .Y(_2610_));
 ...
 sky130_fd_sc_hd__and2b_1 _6278_ (.A_N(_2184_),
    .B(_2138_),
    .X(_2619_));
 sky130_fd_sc_hd__a21oi_1 _6279_ (.A1(_2185_),
    .A2(_2462_),
    .B1(_2619_),
    .Y(_2620_));
 ...
 sky130_fd_sc_hd__nand2_1 _6290_ (.A(_1543_),
    .B(_1312_),
    .Y(_2631_));
 sky130_fd_sc_hd__o211a_1 _6291_ (.A1(_1630_),
    .A2(_1332_),
    .B1(_1555_),
    .C1(_1394_),
    .X(_2632_));
 ...
 sky130_fd_sc_hd__a211o_1 _6338_ (.A1(_2185_),
    ...
    .C1(_2619_),
    .X(_2679_));
 sky130_fd_sc_hd__o311a_2 _6339_ (.A1(_2620_),
    .A2(_2676_),
    .A3(_2677_),
    .B1(_2679_),
    .C1(_0809_),
 ...
 sky130_fd_sc_hd__and3_1 _6352_ (.A(_2563_),
    ...
    .C(_2692_),
    .X(_2693_));
 sky130_fd_sc_hd__a21oi_1 _6353_ (.A1(_2563_),
    .A2(_2613_),
    .B1(_2692_),
    .Y(_2694_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _6671_ (.A(_3010_),
    .X(_0235_));
 sky130_fd_sc_hd__o21ai_1 _6672_ (.A1(_0648_),
    .A2(_1924_),
    .B1(_1922_),
    .Y(_3011_));
 ...
 sky130_fd_sc_hd__xnor2_1 _6697_ (.A(_3019_),
    .B(_3033_),
    .Y(_3034_));
 sky130_fd_sc_hd__o21ai_1 _6698_ (.A1(_0635_),
    .A2(_1924_),
    .B1(_1922_),
    .Y(_3035_));
 ...
 sky130_fd_sc_hd__nand2_1 _6787_ (.A(\execute.sreg_irq_pc.o_d[10] ),
    .B(_1122_),
    .Y(_3114_));
 sky130_fd_sc_hd__o21ai_1 _6788_ (.A1(_0583_),
    .A2(_3045_),
    .B1(_3114_),
    .Y(_3115_));
 ...
 sky130_fd_sc_hd__a2bb2o_1 _6910_ (.A1_N(_3221_),
    ...
    .B2(_3192_),
    .X(_0261_));
 sky130_fd_sc_hd__mux4_1 _6911_ (.A0(_1630_),
    .A1(_2296_),
    .A2(_2117_),
    .A3(_1633_),
    .S0(_1370_),
 ...
 sky130_fd_sc_hd__a21oi_1 _7643_ (.A1(_3738_),
    ...
    .B1(_3753_),
    .Y(_3755_));
 sky130_fd_sc_hd__a2bb2o_1 _7644_ (.A1_N(_3754_),
    .A2_N(_3755_),
    .B1(_3598_),
    .B2(_3151_),
    .X(_3756_));
 sky130_fd_sc_hd__mux2_1 _7645_ (.A0(net240),
    .A1(_3756_),
    .S(_3594_),
    .X(_3757_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _7768_ (.A(_3842_),
    .X(_0500_));
 sky130_fd_sc_hd__dfxtp_1 _7769_ (.CLK(i_clk),
    .D(_0015_),
    .Q(\execute.sreg_priv_control.o_d[0] ));
 sky130_fd_sc_hd__dfxtp_2 _7770_ (.CLK(i_clk),
    .D(_0016_),
    .Q(\execute.sreg_data_page ));
 sky130_fd_sc_hd__dfxtp_2 _7771_ (.CLK(i_clk),
    .D(_0017_),
    .Q(\execute.sreg_long_ptr_en ));
 sky130_fd_sc_hd__dfxtp_1 _7772_ (.CLK(i_clk),
    .D(_0018_),
    .Q(\execute.sreg_priv_control.o_d[4] ));
 sky130_fd_sc_hd__dfxtp_1 _7773_ (.CLK(i_clk),
    .D(_0019_),
    .Q(\execute.sreg_priv_control.o_d[5] ));
 sky130_fd_sc_hd__dfxtp_1 _7774_ (.CLK(i_clk),
    .D(_0020_),
    .Q(\execute.sreg_priv_control.o_d[6] ));
 sky130_fd_sc_hd__dfxtp_1 _7775_ (.CLK(i_clk),
    .D(_0021_),
    .Q(\execute.sreg_priv_control.o_d[7] ));
 sky130_fd_sc_hd__dfxtp_1 _7776_ (.CLK(i_clk),
    .D(_0022_),
    .Q(\execute.sreg_priv_control.o_d[8] ));
 sky130_fd_sc_hd__dfxtp_1 _7777_ (.CLK(i_clk),
    .D(_0023_),
    .Q(\execute.sreg_priv_control.o_d[9] ));
 sky130_fd_sc_hd__dfxtp_1 _7778_ (.CLK(i_clk),
    .D(_0024_),
    .Q(\execute.sreg_priv_control.o_d[10] ));
 sky130_fd_sc_hd__dfxtp_1 _7779_ (.CLK(i_clk),
    .D(_0025_),
    .Q(\execute.sreg_priv_control.o_d[11] ));
 sky130_fd_sc_hd__dfxtp_1 _7780_ (.CLK(i_clk),
    .D(_0026_),
    .Q(\execute.sreg_priv_control.o_d[12] ));
 sky130_fd_sc_hd__dfxtp_1 _7781_ (.CLK(i_clk),
    .D(_0027_),
    .Q(\execute.sreg_priv_control.o_d[13] ));
 sky130_fd_sc_hd__dfxtp_1 _7782_ (.CLK(i_clk),
    .D(_0028_),
    .Q(\execute.sreg_priv_control.o_d[14] ));
 sky130_fd_sc_hd__dfxtp_1 _7783_ (.CLK(i_clk),
    .D(_0029_),
    .Q(\execute.sreg_priv_control.o_d[15] ));
 sky130_fd_sc_hd__dfxtp_1 _7784_ (.CLK(i_clk),
    .D(_0030_),
    .Q(net196));
 sky130_fd_sc_hd__dfxtp_2 _7785_ (.CLK(i_clk),
    .D(_0031_),
    .Q(\fetch.pc_reset_override ));
 sky130_fd_sc_hd__dfxtp_1 _7786_ (.CLK(i_clk),
    .D(_0032_),
    .Q(\fetch.pc_flush_override ));
 sky130_fd_sc_hd__dfxtp_1 _7787_ (.CLK(i_clk),
    .D(_0033_),
    .Q(\fetch.flush_event_invalidate ));
 sky130_fd_sc_hd__dfxtp_2 _7788_ (.CLK(i_clk),
    .D(_0034_),
    .Q(net102));
 sky130_fd_sc_hd__dfxtp_1 _7789_ (.CLK(i_clk),
    .D(_0035_),
    .Q(\decode.i_instr_l[0] ));
 sky130_fd_sc_hd__dfxtp_1 _7790_ (.CLK(i_clk),
    .D(_0036_),
    .Q(\decode.i_instr_l[1] ));
 sky130_fd_sc_hd__dfxtp_1 _7791_ (.CLK(i_clk),
    .D(_0037_),
    .Q(\decode.i_instr_l[2] ));
 sky130_fd_sc_hd__dfxtp_1 _7792_ (.CLK(i_clk),
    .D(_0038_),
    .Q(\decode.i_instr_l[3] ));
 sky130_fd_sc_hd__dfxtp_1 _7793_ (.CLK(i_clk),
    .D(_0039_),
    .Q(\decode.i_instr_l[4] ));
 sky130_fd_sc_hd__dfxtp_1 _7794_ (.CLK(i_clk),
    .D(_0040_),
    .Q(\decode.i_instr_l[5] ));
 sky130_fd_sc_hd__dfxtp_1 _7795_ (.CLK(i_clk),
    .D(_0041_),
    .Q(\decode.i_instr_l[6] ));
 sky130_fd_sc_hd__dfxtp_2 _7796_ (.CLK(i_clk),
    .D(_0042_),
    .Q(\decode.i_instr_l[7] ));
 sky130_fd_sc_hd__dfxtp_2 _7797_ (.CLK(i_clk),
    .D(_0043_),
    .Q(\decode.i_instr_l[8] ));
 sky130_fd_sc_hd__dfxtp_1 _7798_ (.CLK(i_clk),
    .D(_0044_),
    .Q(\decode.i_instr_l[9] ));
 sky130_fd_sc_hd__dfxtp_2 _7799_ (.CLK(i_clk),
    .D(_0045_),
    .Q(\decode.i_instr_l[10] ));
 sky130_fd_sc_hd__dfxtp_2 _7800_ (.CLK(i_clk),
    .D(_0046_),
    .Q(\decode.i_instr_l[11] ));
 sky130_fd_sc_hd__dfxtp_1 _7801_ (.CLK(i_clk),
    .D(_0047_),
    .Q(\decode.i_instr_l[12] ));
 sky130_fd_sc_hd__dfxtp_1 _7802_ (.CLK(i_clk),
    .D(_0048_),
    .Q(\decode.i_instr_l[13] ));
 sky130_fd_sc_hd__dfxtp_1 _7803_ (.CLK(i_clk),
    .D(_0049_),
    .Q(\decode.i_instr_l[14] ));
 sky130_fd_sc_hd__dfxtp_2 _7804_ (.CLK(i_clk),
    .D(_0050_),
    .Q(\decode.i_instr_l[15] ));
 sky130_fd_sc_hd__dfxtp_1 _7805_ (.CLK(i_clk),
    .D(_0051_),
    .Q(\decode.i_imm_pass[0] ));
 sky130_fd_sc_hd__dfxtp_1 _7806_ (.CLK(i_clk),
    .D(_0052_),
    .Q(\decode.i_imm_pass[1] ));
 sky130_fd_sc_hd__dfxtp_1 _7807_ (.CLK(i_clk),
    .D(_0053_),
    .Q(\decode.i_imm_pass[2] ));
 sky130_fd_sc_hd__dfxtp_1 _7808_ (.CLK(i_clk),
    .D(_0054_),
    .Q(\decode.i_imm_pass[3] ));
 sky130_fd_sc_hd__dfxtp_1 _7809_ (.CLK(i_clk),
    .D(_0055_),
    .Q(\decode.i_imm_pass[4] ));
 sky130_fd_sc_hd__dfxtp_1 _7810_ (.CLK(i_clk),
    .D(_0056_),
    .Q(\decode.i_imm_pass[5] ));
 sky130_fd_sc_hd__dfxtp_1 _7811_ (.CLK(i_clk),
    .D(_0057_),
    .Q(\decode.i_imm_pass[6] ));
 sky130_fd_sc_hd__dfxtp_1 _7812_ (.CLK(i_clk),
    .D(_0058_),
    .Q(\decode.i_imm_pass[7] ));
 sky130_fd_sc_hd__dfxtp_1 _7813_ (.CLK(i_clk),
    .D(_0059_),
    .Q(\decode.i_imm_pass[8] ));
 sky130_fd_sc_hd__dfxtp_1 _7814_ (.CLK(i_clk),
    .D(_0060_),
    .Q(\decode.i_imm_pass[9] ));
 sky130_fd_sc_hd__dfxtp_1 _7815_ (.CLK(i_clk),
    .D(_0061_),
    .Q(\decode.i_imm_pass[10] ));
 sky130_fd_sc_hd__dfxtp_1 _7816_ (.CLK(i_clk),
    .D(_0062_),
    .Q(\decode.i_imm_pass[11] ));
 sky130_fd_sc_hd__dfxtp_1 _7817_ (.CLK(i_clk),
    .D(_0063_),
    .Q(\decode.i_imm_pass[12] ));
 sky130_fd_sc_hd__dfxtp_1 _7818_ (.CLK(i_clk),
    .D(_0064_),
    .Q(\decode.i_imm_pass[13] ));
 sky130_fd_sc_hd__dfxtp_1 _7819_ (.CLK(i_clk),
    .D(_0065_),
    .Q(\decode.i_imm_pass[14] ));
 sky130_fd_sc_hd__dfxtp_1 _7820_ (.CLK(i_clk),
    .D(_0066_),
    .Q(\decode.i_imm_pass[15] ));
 sky130_fd_sc_hd__dfxtp_2 _7821_ (.CLK(i_clk),
    .D(_0067_),
    .Q(\fetch.prev_request_pc[0] ));
 sky130_fd_sc_hd__dfxtp_2 _7822_ (.CLK(i_clk),
    .D(_0068_),
    .Q(\fetch.prev_request_pc[1] ));
 sky130_fd_sc_hd__dfxtp_1 _7823_ (.CLK(i_clk),
    .D(_0069_),
    .Q(\fetch.prev_request_pc[2] ));
 sky130_fd_sc_hd__dfxtp_1 _7824_ (.CLK(i_clk),
    .D(_0070_),
    .Q(\fetch.prev_request_pc[3] ));
 sky130_fd_sc_hd__dfxtp_1 _7825_ (.CLK(i_clk),
    .D(_0071_),
    .Q(\fetch.prev_request_pc[4] ));
 sky130_fd_sc_hd__dfxtp_1 _7826_ (.CLK(i_clk),
    .D(_0072_),
    .Q(\fetch.prev_request_pc[5] ));
 sky130_fd_sc_hd__dfxtp_1 _7827_ (.CLK(i_clk),
    .D(_0073_),
    .Q(\fetch.prev_request_pc[6] ));
 sky130_fd_sc_hd__dfxtp_1 _7828_ (.CLK(i_clk),
    .D(_0074_),
    .Q(\fetch.prev_request_pc[7] ));
 sky130_fd_sc_hd__dfxtp_1 _7829_ (.CLK(i_clk),
    .D(_0075_),
    .Q(\fetch.prev_request_pc[8] ));
 sky130_fd_sc_hd__dfxtp_1 _7830_ (.CLK(i_clk),
    .D(_0076_),
    .Q(\fetch.prev_request_pc[9] ));
 sky130_fd_sc_hd__dfxtp_1 _7831_ (.CLK(i_clk),
    .D(_0077_),
    .Q(\fetch.prev_request_pc[10] ));
 sky130_fd_sc_hd__dfxtp_1 _7832_ (.CLK(i_clk),
    .D(_0078_),
    .Q(\fetch.prev_request_pc[11] ));
 sky130_fd_sc_hd__dfxtp_1 _7833_ (.CLK(i_clk),
    .D(_0079_),
    .Q(\fetch.prev_request_pc[12] ));
 sky130_fd_sc_hd__dfxtp_1 _7834_ (.CLK(i_clk),
    .D(_0080_),
    .Q(\fetch.prev_request_pc[13] ));
 sky130_fd_sc_hd__dfxtp_1 _7835_ (.CLK(i_clk),
    .D(_0081_),
    .Q(\fetch.prev_request_pc[14] ));
 sky130_fd_sc_hd__dfxtp_1 _7836_ (.CLK(i_clk),
    .D(_0082_),
    .Q(\fetch.prev_request_pc[15] ));
 sky130_fd_sc_hd__dfxtp_1 _7837_ (.CLK(i_clk),
    .D(\fetch.submitable ),
    .Q(\decode.i_submit ));
 sky130_fd_sc_hd__dfxtp_1 _7838_ (.CLK(i_clk),
    .D(_0083_),
    .Q(\fetch.out_buffer_data_pred ));
 sky130_fd_sc_hd__dfxtp_1 _7839_ (.CLK(i_clk),
    .D(\fetch.current_req_branch_pred ),
    .Q(\fetch.prev_req_branch_pred ));
 sky130_fd_sc_hd__dfxtp_2 _7840_ (.CLK(i_clk),
    .D(_0084_),
    .Q(\fetch.out_buffer_valid ));
 sky130_fd_sc_hd__dfxtp_1 _7841_ (.CLK(i_clk),
    .D(_0085_),
    .Q(\fetch.out_buffer_data_instr[0] ));
 sky130_fd_sc_hd__dfxtp_1 _7842_ (.CLK(i_clk),
    .D(_0086_),
    .Q(\fetch.out_buffer_data_instr[1] ));
 sky130_fd_sc_hd__dfxtp_1 _7843_ (.CLK(i_clk),
    .D(_0087_),
    .Q(\fetch.out_buffer_data_instr[2] ));
 sky130_fd_sc_hd__dfxtp_1 _7844_ (.CLK(i_clk),
    .D(_0088_),
    .Q(\fetch.out_buffer_data_instr[3] ));
 sky130_fd_sc_hd__dfxtp_1 _7845_ (.CLK(i_clk),
    .D(_0089_),
    .Q(\fetch.out_buffer_data_instr[4] ));
 sky130_fd_sc_hd__dfxtp_1 _7846_ (.CLK(i_clk),
    .D(_0090_),
    .Q(\fetch.out_buffer_data_instr[5] ));
 sky130_fd_sc_hd__dfxtp_1 _7847_ (.CLK(i_clk),
    .D(_0091_),
    .Q(\fetch.out_buffer_data_instr[6] ));
 sky130_fd_sc_hd__dfxtp_1 _7848_ (.CLK(i_clk),
    .D(_0092_),
    .Q(\fetch.out_buffer_data_instr[7] ));
 sky130_fd_sc_hd__dfxtp_1 _7849_ (.CLK(i_clk),
    .D(_0093_),
    .Q(\fetch.out_buffer_data_instr[8] ));
 sky130_fd_sc_hd__dfxtp_1 _7850_ (.CLK(i_clk),
    .D(_0094_),
    .Q(\fetch.out_buffer_data_instr[9] ));
 sky130_fd_sc_hd__dfxtp_1 _7851_ (.CLK(i_clk),
    .D(_0095_),
    .Q(\fetch.out_buffer_data_instr[10] ));
 sky130_fd_sc_hd__dfxtp_1 _7852_ (.CLK(i_clk),
    .D(_0096_),
    .Q(\fetch.out_buffer_data_instr[11] ));
 sky130_fd_sc_hd__dfxtp_1 _7853_ (.CLK(i_clk),
    .D(_0097_),
    .Q(\fetch.out_buffer_data_instr[12] ));
 sky130_fd_sc_hd__dfxtp_1 _7854_ (.CLK(i_clk),
    .D(_0098_),
    .Q(\fetch.out_buffer_data_instr[13] ));
 sky130_fd_sc_hd__dfxtp_1 _7855_ (.CLK(i_clk),
    .D(_0099_),
    .Q(\fetch.out_buffer_data_instr[14] ));
 sky130_fd_sc_hd__dfxtp_1 _7856_ (.CLK(i_clk),
    .D(_0100_),
    .Q(\fetch.out_buffer_data_instr[15] ));
 sky130_fd_sc_hd__dfxtp_1 _7857_ (.CLK(i_clk),
    .D(_0101_),
    .Q(\fetch.out_buffer_data_instr[16] ));
 sky130_fd_sc_hd__dfxtp_1 _7858_ (.CLK(i_clk),
    .D(_0102_),
    .Q(\fetch.out_buffer_data_instr[17] ));
 sky130_fd_sc_hd__dfxtp_1 _7859_ (.CLK(i_clk),
    .D(_0103_),
    .Q(\fetch.out_buffer_data_instr[18] ));
 sky130_fd_sc_hd__dfxtp_1 _7860_ (.CLK(i_clk),
    .D(_0104_),
    .Q(\fetch.out_buffer_data_instr[19] ));
 sky130_fd_sc_hd__dfxtp_1 _7861_ (.CLK(i_clk),
    .D(_0105_),
    .Q(\fetch.out_buffer_data_instr[20] ));
 sky130_fd_sc_hd__dfxtp_1 _7862_ (.CLK(i_clk),
    .D(_0106_),
    .Q(\fetch.out_buffer_data_instr[21] ));
 sky130_fd_sc_hd__dfxtp_1 _7863_ (.CLK(i_clk),
    .D(_0107_),
    .Q(\fetch.out_buffer_data_instr[22] ));
 sky130_fd_sc_hd__dfxtp_1 _7864_ (.CLK(i_clk),
    .D(_0108_),
    .Q(\fetch.out_buffer_data_instr[23] ));
 sky130_fd_sc_hd__dfxtp_1 _7865_ (.CLK(i_clk),
    .D(_0109_),
    .Q(\fetch.out_buffer_data_instr[24] ));
 sky130_fd_sc_hd__dfxtp_1 _7866_ (.CLK(i_clk),
    .D(_0110_),
    .Q(\fetch.out_buffer_data_instr[25] ));
 sky130_fd_sc_hd__dfxtp_1 _7867_ (.CLK(i_clk),
    .D(_0111_),
    .Q(\fetch.out_buffer_data_instr[26] ));
 sky130_fd_sc_hd__dfxtp_1 _7868_ (.CLK(i_clk),
    .D(_0112_),
    .Q(\fetch.out_buffer_data_instr[27] ));
 sky130_fd_sc_hd__dfxtp_1 _7869_ (.CLK(i_clk),
    .D(_0113_),
    .Q(\fetch.out_buffer_data_instr[28] ));
 sky130_fd_sc_hd__dfxtp_1 _7870_ (.CLK(i_clk),
    .D(_0114_),
    .Q(\fetch.out_buffer_data_instr[29] ));
 sky130_fd_sc_hd__dfxtp_1 _7871_ (.CLK(i_clk),
    .D(_0115_),
    .Q(\fetch.out_buffer_data_instr[30] ));
 sky130_fd_sc_hd__dfxtp_1 _7872_ (.CLK(i_clk),
    .D(_0116_),
    .Q(\fetch.out_buffer_data_instr[31] ));
 sky130_fd_sc_hd__dfxtp_1 _7873_ (.CLK(i_clk),
    .D(_0117_),
    .Q(\execute.alu_mul_div.div_cur[0] ));
 sky130_fd_sc_hd__dfxtp_1 _7874_ (.CLK(i_clk),
    .D(_0118_),
    .Q(\execute.alu_mul_div.cbit[1] ));
 sky130_fd_sc_hd__dfxtp_2 _7875_ (.CLK(i_clk),
    .D(_0119_),
    .Q(\execute.alu_mul_div.cbit[2] ));
 sky130_fd_sc_hd__dfxtp_1 _7876_ (.CLK(i_clk),
    .D(_0120_),
    .Q(\execute.alu_mul_div.cbit[3] ));
 sky130_fd_sc_hd__dfxtp_1 _7877_ (.CLK(i_clk),
    .D(_0121_),
    .Q(net83));
 sky130_fd_sc_hd__dfxtp_1 _7878_ (.CLK(i_clk),
    .D(_0004_),
    .Q(\decode.oc_alu_mode[1] ));
 sky130_fd_sc_hd__dfxtp_1 _7879_ (.CLK(i_clk),
    .D(_0005_),
    .Q(\decode.oc_alu_mode[2] ));
 sky130_fd_sc_hd__dfxtp_1 _7880_ (.CLK(i_clk),
    .D(_0006_),
    .Q(\decode.oc_alu_mode[3] ));
 sky130_fd_sc_hd__dfxtp_2 _7881_ (.CLK(i_clk),
    .D(_0007_),
    .Q(\decode.oc_alu_mode[4] ));
 sky130_fd_sc_hd__dfxtp_1 _7882_ (.CLK(i_clk),
    .D(_0008_),
    .Q(\execute.alu_mul_div.i_div ));
 sky130_fd_sc_hd__dfxtp_4 _7883_ (.CLK(i_clk),
    .D(_0009_),
    .Q(\decode.oc_alu_mode[6] ));
 sky130_fd_sc_hd__dfxtp_1 _7884_ (.CLK(i_clk),
    .D(_0010_),
    .Q(\decode.oc_alu_mode[7] ));
 sky130_fd_sc_hd__dfxtp_4 _7885_ (.CLK(i_clk),
    .D(_0011_),
    .Q(\execute.alu_mul_div.i_mul ));
 sky130_fd_sc_hd__dfxtp_4 _7886_ (.CLK(i_clk),
    .D(_0012_),
    .Q(\decode.oc_alu_mode[9] ));
 sky130_fd_sc_hd__dfxtp_1 _7887_ (.CLK(i_clk),
    .D(_0000_),
    .Q(\execute.alu_mul_div.i_mod ));
 sky130_fd_sc_hd__dfxtp_4 _7888_ (.CLK(i_clk),
    .D(_0001_),
    .Q(\decode.oc_alu_mode[11] ));
 sky130_fd_sc_hd__dfxtp_2 _7889_ (.CLK(i_clk),
    .D(_0002_),
    .Q(\decode.oc_alu_mode[12] ));
 sky130_fd_sc_hd__dfxtp_1 _7890_ (.CLK(i_clk),
    .D(_0003_),
    .Q(\decode.oc_alu_mode[13] ));
 sky130_fd_sc_hd__dfxtp_1 _7891_ (.CLK(i_clk),
    .D(_0122_),
    .Q(\decode.i_jmp_pred_pass ));
 sky130_fd_sc_hd__dfxtp_1 _7892_ (.CLK(i_clk),
    .D(_0123_),
    .Q(\decode.input_valid ));
 sky130_fd_sc_hd__dfxtp_1 _7893_ (.CLK(i_clk),
    .D(_0124_),
    .Q(\decode.oc_mem_width ));
 sky130_fd_sc_hd__dfxtp_1 _7894_ (.CLK(i_clk),
    .D(_0125_),
    .Q(\decode.oc_sys ));
 sky130_fd_sc_hd__dfxtp_1 _7895_ (.CLK(i_clk),
    .D(_0126_),
    .Q(\decode.oc_sreg_irt ));
 sky130_fd_sc_hd__dfxtp_1 _7896_ (.CLK(i_clk),
    .D(_0127_),
    .Q(\decode.oc_sreg_jal_over ));
 sky130_fd_sc_hd__dfxtp_1 _7897_ (.CLK(i_clk),
    .D(_0128_),
    .Q(\decode.oc_sreg_store ));
 sky130_fd_sc_hd__dfxtp_1 _7898_ (.CLK(i_clk),
    .D(_0129_),
    .Q(\decode.oc_sreg_load ));
 sky130_fd_sc_hd__dfxtp_1 _7899_ (.CLK(i_clk),
    .D(_0130_),
    .Q(\decode.oc_used_operands[0] ));
 sky130_fd_sc_hd__dfxtp_1 _7900_ (.CLK(i_clk),
    .D(_0131_),
    .Q(\decode.oc_used_operands[1] ));
 sky130_fd_sc_hd__dfxtp_1 _7901_ (.CLK(i_clk),
    .D(_0132_),
    .Q(\decode.oc_mem_we ));
 sky130_fd_sc_hd__dfxtp_2 _7902_ (.CLK(i_clk),
    .D(_0133_),
    .Q(\decode.oc_mem_access ));
 sky130_fd_sc_hd__dfxtp_1 _7903_ (.CLK(i_clk),
    .D(_0134_),
    .Q(\decode.o_jmp_pred_pass ));
 sky130_fd_sc_hd__dfxtp_2 _7904_ (.CLK(i_clk),
    .D(_0135_),
    .Q(\decode.oc_jump_cond_code[0] ));
 sky130_fd_sc_hd__dfxtp_2 _7905_ (.CLK(i_clk),
    .D(_0136_),
    .Q(\decode.oc_jump_cond_code[1] ));
 sky130_fd_sc_hd__dfxtp_2 _7906_ (.CLK(i_clk),
    .D(_0137_),
    .Q(\decode.oc_jump_cond_code[2] ));
 sky130_fd_sc_hd__dfxtp_1 _7907_ (.CLK(i_clk),
    .D(_0138_),
    .Q(\decode.oc_jump_cond_code[3] ));
 sky130_fd_sc_hd__dfxtp_1 _7908_ (.CLK(i_clk),
    .D(_0139_),
    .Q(\decode.oc_jump_cond_code[4] ));
 sky130_fd_sc_hd__dfxtp_1 _7909_ (.CLK(i_clk),
    .D(_0140_),
    .Q(\decode.oc_r_reg_sel[0] ));
 sky130_fd_sc_hd__dfxtp_1 _7910_ (.CLK(i_clk),
    .D(_0141_),
    .Q(\decode.oc_r_reg_sel[1] ));
 sky130_fd_sc_hd__dfxtp_1 _7911_ (.CLK(i_clk),
    .D(_0142_),
    .Q(\decode.oc_r_reg_sel[2] ));
 sky130_fd_sc_hd__dfxtp_1 _7912_ (.CLK(i_clk),
    .D(_0143_),
    .Q(\decode.oc_rf_ie[0] ));
 sky130_fd_sc_hd__dfxtp_1 _7913_ (.CLK(i_clk),
    .D(_0144_),
    .Q(\decode.oc_rf_ie[1] ));
 sky130_fd_sc_hd__dfxtp_1 _7914_ (.CLK(i_clk),
    .D(_0145_),
    .Q(\decode.oc_rf_ie[2] ));
 sky130_fd_sc_hd__dfxtp_1 _7915_ (.CLK(i_clk),
    .D(_0146_),
    .Q(\decode.oc_rf_ie[3] ));
 sky130_fd_sc_hd__dfxtp_1 _7916_ (.CLK(i_clk),
    .D(_0147_),
    .Q(\decode.oc_rf_ie[4] ));
 sky130_fd_sc_hd__dfxtp_1 _7917_ (.CLK(i_clk),
    .D(_0148_),
    .Q(\decode.oc_rf_ie[5] ));
 sky130_fd_sc_hd__dfxtp_1 _7918_ (.CLK(i_clk),
    .D(_0149_),
    .Q(\decode.oc_rf_ie[6] ));
 sky130_fd_sc_hd__dfxtp_1 _7919_ (.CLK(i_clk),
    .D(_0150_),
    .Q(\decode.oc_rf_ie[7] ));
 sky130_fd_sc_hd__dfxtp_2 _7920_ (.CLK(i_clk),
    .D(_0151_),
    .Q(\decode.oc_l_reg_sel[0] ));
 sky130_fd_sc_hd__dfxtp_1 _7921_ (.CLK(i_clk),
    .D(_0152_),
    .Q(\decode.oc_l_reg_sel[1] ));
 sky130_fd_sc_hd__dfxtp_2 _7922_ (.CLK(i_clk),
    .D(_0153_),
    .Q(\decode.oc_l_reg_sel[2] ));
 sky130_fd_sc_hd__dfxtp_2 _7923_ (.CLK(i_clk),
    .D(_0154_),
    .Q(\decode.oc_alu_carry_en ));
 sky130_fd_sc_hd__dfxtp_1 _7924_ (.CLK(i_clk),
    .D(_0155_),
    .Q(\decode.oc_alu_flags_ie ));
 sky130_fd_sc_hd__dfxtp_1 _7925_ (.CLK(i_clk),
    .D(_0156_),
    .Q(\decode.oc_r_bus_imm ));
 sky130_fd_sc_hd__dfxtp_1 _7926_ (.CLK(i_clk),
    .D(_0157_),
    .Q(\decode.oc_pc_inc ));
 sky130_fd_sc_hd__dfxtp_2 _7927_ (.CLK(i_clk),
    .D(_0158_),
    .Q(net218));
 sky130_fd_sc_hd__dfxtp_4 _7928_ (.CLK(i_clk),
    .D(_0159_),
    .Q(net225));
 sky130_fd_sc_hd__dfxtp_2 _7929_ (.CLK(i_clk),
    .D(_0160_),
    .Q(net226));
 sky130_fd_sc_hd__dfxtp_2 _7930_ (.CLK(i_clk),
    .D(_0161_),
    .Q(net227));
 sky130_fd_sc_hd__dfxtp_2 _7931_ (.CLK(i_clk),
    .D(_0162_),
    .Q(net228));
 sky130_fd_sc_hd__dfxtp_2 _7932_ (.CLK(i_clk),
    .D(_0163_),
    .Q(net229));
 sky130_fd_sc_hd__dfxtp_2 _7933_ (.CLK(i_clk),
    .D(_0164_),
    .Q(net230));
 sky130_fd_sc_hd__dfxtp_2 _7934_ (.CLK(i_clk),
    .D(_0165_),
    .Q(net231));
 sky130_fd_sc_hd__dfxtp_2 _7935_ (.CLK(i_clk),
    .D(_0166_),
    .Q(net232));
 sky130_fd_sc_hd__dfxtp_2 _7936_ (.CLK(i_clk),
    .D(_0167_),
    .Q(net233));
 sky130_fd_sc_hd__dfxtp_2 _7937_ (.CLK(i_clk),
    .D(_0168_),
    .Q(net219));
 sky130_fd_sc_hd__dfxtp_2 _7938_ (.CLK(i_clk),
    .D(_0169_),
    .Q(net220));
 sky130_fd_sc_hd__dfxtp_2 _7939_ (.CLK(i_clk),
    .D(_0170_),
    .Q(net221));
 sky130_fd_sc_hd__dfxtp_2 _7940_ (.CLK(i_clk),
    .D(_0171_),
    .Q(net222));
 sky130_fd_sc_hd__dfxtp_4 _7941_ (.CLK(i_clk),
    .D(_0172_),
    .Q(net223));
 sky130_fd_sc_hd__dfxtp_2 _7942_ (.CLK(i_clk),
    .D(_0173_),
    .Q(net224));
 sky130_fd_sc_hd__dfxtp_2 _7943_ (.CLK(i_clk),
    .D(_0174_),
    .Q(\decode.o_submit ));
 sky130_fd_sc_hd__dfxtp_1 _7944_ (.CLK(i_clk),
    .D(_0175_),
    .Q(\execute.pc_high_buff_out[0] ));
 sky130_fd_sc_hd__dfxtp_1 _7945_ (.CLK(i_clk),
    .D(_0176_),
    .Q(\execute.pc_high_buff_out[1] ));
 sky130_fd_sc_hd__dfxtp_1 _7946_ (.CLK(i_clk),
    .D(_0177_),
    .Q(\execute.pc_high_buff_out[2] ));
 sky130_fd_sc_hd__dfxtp_1 _7947_ (.CLK(i_clk),
    .D(_0178_),
    .Q(\execute.pc_high_buff_out[3] ));
 sky130_fd_sc_hd__dfxtp_1 _7948_ (.CLK(i_clk),
    .D(_0179_),
    .Q(\execute.pc_high_buff_out[4] ));
 sky130_fd_sc_hd__dfxtp_1 _7949_ (.CLK(i_clk),
    .D(_0180_),
    .Q(\execute.pc_high_buff_out[5] ));
 sky130_fd_sc_hd__dfxtp_1 _7950_ (.CLK(i_clk),
    .D(_0181_),
    .Q(\execute.pc_high_buff_out[6] ));
 sky130_fd_sc_hd__dfxtp_1 _7951_ (.CLK(i_clk),
    .D(_0182_),
    .Q(\execute.pc_high_buff_out[7] ));
 sky130_fd_sc_hd__dfxtp_2 _7952_ (.CLK(i_clk),
    .D(_0183_),
    .Q(\execute.pc_high_out[0] ));
 sky130_fd_sc_hd__dfxtp_2 _7953_ (.CLK(i_clk),
    .D(_0184_),
    .Q(\execute.pc_high_out[1] ));
 sky130_fd_sc_hd__dfxtp_1 _7954_ (.CLK(i_clk),
    .D(_0185_),
    .Q(\execute.pc_high_out[2] ));
 sky130_fd_sc_hd__dfxtp_1 _7955_ (.CLK(i_clk),
    .D(_0186_),
    .Q(\execute.pc_high_out[3] ));
 sky130_fd_sc_hd__dfxtp_2 _7956_ (.CLK(i_clk),
    .D(_0187_),
    .Q(\execute.pc_high_out[4] ));
 sky130_fd_sc_hd__dfxtp_2 _7957_ (.CLK(i_clk),
    .D(_0188_),
    .Q(\execute.pc_high_out[5] ));
 sky130_fd_sc_hd__dfxtp_1 _7958_ (.CLK(i_clk),
    .D(_0189_),
    .Q(\execute.pc_high_out[6] ));
 sky130_fd_sc_hd__dfxtp_1 _7959_ (.CLK(i_clk),
    .D(_0190_),
    .Q(\execute.pc_high_out[7] ));
 sky130_fd_sc_hd__dfxtp_1 _7960_ (.CLK(i_clk),
    .D(_0191_),
    .Q(\execute.sreg_irq_flags.o_d[0] ));
 sky130_fd_sc_hd__dfxtp_1 _7961_ (.CLK(i_clk),
    .D(_0192_),
    .Q(\execute.sreg_irq_flags.o_d[1] ));
 sky130_fd_sc_hd__dfxtp_1 _7962_ (.CLK(i_clk),
    .D(_0193_),
    .Q(\execute.sreg_irq_flags.o_d[2] ));
 sky130_fd_sc_hd__dfxtp_1 _7963_ (.CLK(i_clk),
    .D(_0194_),
    .Q(\execute.sreg_irq_flags.o_d[3] ));
 sky130_fd_sc_hd__dfxtp_1 _7964_ (.CLK(i_clk),
    .D(_0195_),
    .Q(\execute.sreg_irq_flags.o_d[4] ));
 sky130_fd_sc_hd__dfxtp_1 _7965_ (.CLK(i_clk),
    .D(_0196_),
    .Q(\execute.sreg_scratch.o_d[0] ));
 sky130_fd_sc_hd__dfxtp_1 _7966_ (.CLK(i_clk),
    .D(_0197_),
    .Q(\execute.sreg_scratch.o_d[1] ));
 sky130_fd_sc_hd__dfxtp_1 _7967_ (.CLK(i_clk),
    .D(_0198_),
    .Q(\execute.sreg_scratch.o_d[2] ));
 sky130_fd_sc_hd__dfxtp_1 _7968_ (.CLK(i_clk),
    .D(_0199_),
    .Q(\execute.sreg_scratch.o_d[3] ));
 sky130_fd_sc_hd__dfxtp_1 _7969_ (.CLK(i_clk),
    .D(_0200_),
    .Q(\execute.sreg_scratch.o_d[4] ));
 sky130_fd_sc_hd__dfxtp_1 _7970_ (.CLK(i_clk),
    .D(_0201_),
    .Q(\execute.sreg_scratch.o_d[5] ));
 sky130_fd_sc_hd__dfxtp_1 _7971_ (.CLK(i_clk),
    .D(_0202_),
    .Q(\execute.sreg_scratch.o_d[6] ));
 sky130_fd_sc_hd__dfxtp_1 _7972_ (.CLK(i_clk),
    .D(_0203_),
    .Q(\execute.sreg_scratch.o_d[7] ));
 sky130_fd_sc_hd__dfxtp_1 _7973_ (.CLK(i_clk),
    .D(_0204_),
    .Q(\execute.sreg_scratch.o_d[8] ));
 sky130_fd_sc_hd__dfxtp_1 _7974_ (.CLK(i_clk),
    .D(_0205_),
    .Q(\execute.sreg_scratch.o_d[9] ));
 sky130_fd_sc_hd__dfxtp_1 _7975_ (.CLK(i_clk),
    .D(_0206_),
    .Q(\execute.sreg_scratch.o_d[10] ));
 sky130_fd_sc_hd__dfxtp_1 _7976_ (.CLK(i_clk),
    .D(_0207_),
    .Q(\execute.sreg_scratch.o_d[11] ));
 sky130_fd_sc_hd__dfxtp_1 _7977_ (.CLK(i_clk),
    .D(_0208_),
    .Q(\execute.sreg_scratch.o_d[12] ));
 sky130_fd_sc_hd__dfxtp_1 _7978_ (.CLK(i_clk),
    .D(_0209_),
    .Q(\execute.sreg_scratch.o_d[13] ));
 sky130_fd_sc_hd__dfxtp_1 _7979_ (.CLK(i_clk),
    .D(_0210_),
    .Q(\execute.sreg_scratch.o_d[14] ));
 sky130_fd_sc_hd__dfxtp_1 _7980_ (.CLK(i_clk),
    .D(_0211_),
    .Q(\execute.sreg_scratch.o_d[15] ));
 sky130_fd_sc_hd__dfxtp_2 _7981_ (.CLK(i_clk),
    .D(_0212_),
    .Q(net146));
 sky130_fd_sc_hd__dfxtp_1 _7982_ (.CLK(i_clk),
    .D(_0213_),
    .Q(\execute.trap_flag ));
 sky130_fd_sc_hd__dfxtp_4 _7983_ (.CLK(i_clk),
    .D(_0214_),
    .Q(net145));
 sky130_fd_sc_hd__dfxtp_1 _7984_ (.CLK(i_clk),
    .D(_0215_),
    .Q(\execute.sreg_jtr_buff.o_d[0] ));
 sky130_fd_sc_hd__dfxtp_1 _7985_ (.CLK(i_clk),
    .D(_0216_),
    .Q(\execute.sreg_jtr_buff.o_d[1] ));
 sky130_fd_sc_hd__dfxtp_1 _7986_ (.CLK(i_clk),
    .D(_0217_),
    .Q(\execute.sreg_jtr_buff.o_d[2] ));
 sky130_fd_sc_hd__dfxtp_1 _7987_ (.CLK(i_clk),
    .D(_0218_),
    .Q(\execute.sreg_irq_pc.o_d[0] ));
 sky130_fd_sc_hd__dfxtp_2 _7988_ (.CLK(i_clk),
    .D(_0219_),
    .Q(\execute.sreg_irq_pc.o_d[1] ));
 sky130_fd_sc_hd__dfxtp_2 _7989_ (.CLK(i_clk),
    .D(_0220_),
    .Q(\execute.sreg_irq_pc.o_d[2] ));
 sky130_fd_sc_hd__dfxtp_1 _7990_ (.CLK(i_clk),
    .D(_0221_),
    .Q(\execute.sreg_irq_pc.o_d[3] ));
 sky130_fd_sc_hd__dfxtp_2 _7991_ (.CLK(i_clk),
    .D(_0222_),
    .Q(\execute.sreg_irq_pc.o_d[4] ));
 sky130_fd_sc_hd__dfxtp_2 _7992_ (.CLK(i_clk),
    .D(_0223_),
    .Q(\execute.sreg_irq_pc.o_d[5] ));
 sky130_fd_sc_hd__dfxtp_2 _7993_ (.CLK(i_clk),
    .D(_0224_),
    .Q(\execute.sreg_irq_pc.o_d[6] ));
 sky130_fd_sc_hd__dfxtp_2 _7994_ (.CLK(i_clk),
    .D(_0225_),
    .Q(\execute.sreg_irq_pc.o_d[7] ));
 sky130_fd_sc_hd__dfxtp_1 _7995_ (.CLK(i_clk),
    .D(_0226_),
    .Q(\execute.sreg_irq_pc.o_d[8] ));
 sky130_fd_sc_hd__dfxtp_1 _7996_ (.CLK(i_clk),
    .D(_0227_),
    .Q(\execute.sreg_irq_pc.o_d[9] ));
 sky130_fd_sc_hd__dfxtp_1 _7997_ (.CLK(i_clk),
    .D(_0228_),
    .Q(\execute.sreg_irq_pc.o_d[10] ));
 sky130_fd_sc_hd__dfxtp_1 _7998_ (.CLK(i_clk),
    .D(_0229_),
    .Q(\execute.sreg_irq_pc.o_d[11] ));
 sky130_fd_sc_hd__dfxtp_1 _7999_ (.CLK(i_clk),
    .D(_0230_),
    .Q(\execute.sreg_irq_pc.o_d[12] ));
 sky130_fd_sc_hd__dfxtp_1 _8000_ (.CLK(i_clk),
    .D(_0231_),
    .Q(\execute.sreg_irq_pc.o_d[13] ));
 sky130_fd_sc_hd__dfxtp_1 _8001_ (.CLK(i_clk),
    .D(_0232_),
    .Q(\execute.sreg_irq_pc.o_d[14] ));
 sky130_fd_sc_hd__dfxtp_1 _8002_ (.CLK(i_clk),
    .D(_0233_),
    .Q(\execute.sreg_irq_pc.o_d[15] ));
 sky130_fd_sc_hd__dfxtp_2 _8003_ (.CLK(i_clk),
    .D(_0234_),
    .Q(\execute.alu_flag_reg.o_d[0] ));
 sky130_fd_sc_hd__dfxtp_2 _8004_ (.CLK(i_clk),
    .D(_0235_),
    .Q(\execute.alu_flag_reg.o_d[1] ));
 sky130_fd_sc_hd__dfxtp_1 _8005_ (.CLK(i_clk),
    .D(_0236_),
    .Q(\execute.alu_flag_reg.o_d[2] ));
 sky130_fd_sc_hd__dfxtp_1 _8006_ (.CLK(i_clk),
    .D(_0237_),
    .Q(\execute.alu_flag_reg.o_d[3] ));
 sky130_fd_sc_hd__dfxtp_1 _8007_ (.CLK(i_clk),
    .D(_0238_),
    .Q(\execute.alu_flag_reg.o_d[4] ));
 sky130_fd_sc_hd__dfxtp_4 _8008_ (.CLK(i_clk),
    .D(_0239_),
    .Q(net84));
 sky130_fd_sc_hd__dfxtp_4 _8009_ (.CLK(i_clk),
    .D(_0240_),
    .Q(net85));
 sky130_fd_sc_hd__dfxtp_4 _8010_ (.CLK(i_clk),
    .D(_0241_),
    .Q(net86));
 sky130_fd_sc_hd__dfxtp_4 _8011_ (.CLK(i_clk),
    .D(_0242_),
    .Q(net88));
 sky130_fd_sc_hd__dfxtp_4 _8012_ (.CLK(i_clk),
    .D(_0243_),
    .Q(net89));
 sky130_fd_sc_hd__dfxtp_4 _8013_ (.CLK(i_clk),
    .D(_0244_),
    .Q(net90));
 sky130_fd_sc_hd__dfxtp_4 _8014_ (.CLK(i_clk),
    .D(_0245_),
    .Q(net91));
 sky130_fd_sc_hd__dfxtp_4 _8015_ (.CLK(i_clk),
    .D(_0246_),
    .Q(net92));
 sky130_fd_sc_hd__dfxtp_4 _8016_ (.CLK(i_clk),
    .D(_0247_),
    .Q(net93));
 sky130_fd_sc_hd__dfxtp_4 _8017_ (.CLK(i_clk),
    .D(_0248_),
    .Q(net94));
 sky130_fd_sc_hd__dfxtp_4 _8018_ (.CLK(i_clk),
    .D(_0249_),
    .Q(net95));
 sky130_fd_sc_hd__dfxtp_4 _8019_ (.CLK(i_clk),
    .D(_0250_),
    .Q(net96));
 sky130_fd_sc_hd__dfxtp_1 _8020_ (.CLK(i_clk),
    .D(_0251_),
    .Q(net97));
 sky130_fd_sc_hd__dfxtp_4 _8021_ (.CLK(i_clk),
    .D(_0252_),
    .Q(net99));
 sky130_fd_sc_hd__dfxtp_4 _8022_ (.CLK(i_clk),
    .D(_0253_),
    .Q(net100));
 sky130_fd_sc_hd__dfxtp_1 _8023_ (.CLK(i_clk),
    .D(_0254_),
    .Q(\execute.next_ready_delayed ));
 sky130_fd_sc_hd__dfxtp_1 _8024_ (.CLK(i_clk),
    .D(_0255_),
    .Q(\execute.alu_mul_div.mul_res[0] ));
 sky130_fd_sc_hd__dfxtp_1 _8025_ (.CLK(i_clk),
    .D(_0256_),
    .Q(\execute.alu_mul_div.mul_res[1] ));
 sky130_fd_sc_hd__dfxtp_2 _8026_ (.CLK(i_clk),
    .D(_0257_),
    .Q(\execute.alu_mul_div.mul_res[2] ));
 sky130_fd_sc_hd__dfxtp_2 _8027_ (.CLK(i_clk),
    .D(_0258_),
    .Q(\execute.alu_mul_div.mul_res[3] ));
 sky130_fd_sc_hd__dfxtp_2 _8028_ (.CLK(i_clk),
    .D(_0259_),
    .Q(\execute.alu_mul_div.mul_res[4] ));
 sky130_fd_sc_hd__dfxtp_2 _8029_ (.CLK(i_clk),
    .D(_0260_),
    .Q(\execute.alu_mul_div.mul_res[5] ));
 sky130_fd_sc_hd__dfxtp_2 _8030_ (.CLK(i_clk),
    .D(_0261_),
    .Q(\execute.alu_mul_div.mul_res[6] ));
 sky130_fd_sc_hd__dfxtp_2 _8031_ (.CLK(i_clk),
    .D(_0262_),
    .Q(\execute.alu_mul_div.mul_res[7] ));
 sky130_fd_sc_hd__dfxtp_2 _8032_ (.CLK(i_clk),
    .D(_0263_),
    .Q(\execute.alu_mul_div.mul_res[8] ));
 sky130_fd_sc_hd__dfxtp_2 _8033_ (.CLK(i_clk),
    .D(_0264_),
    .Q(\execute.alu_mul_div.mul_res[9] ));
 sky130_fd_sc_hd__dfxtp_2 _8034_ (.CLK(i_clk),
    .D(_0265_),
    .Q(\execute.alu_mul_div.mul_res[10] ));
 sky130_fd_sc_hd__dfxtp_2 _8035_ (.CLK(i_clk),
    .D(_0266_),
    .Q(\execute.alu_mul_div.mul_res[11] ));
 sky130_fd_sc_hd__dfxtp_2 _8036_ (.CLK(i_clk),
    .D(_0267_),
    .Q(\execute.alu_mul_div.mul_res[12] ));
 sky130_fd_sc_hd__dfxtp_2 _8037_ (.CLK(i_clk),
    .D(_0268_),
    .Q(\execute.alu_mul_div.mul_res[13] ));
 sky130_fd_sc_hd__dfxtp_2 _8038_ (.CLK(i_clk),
    .D(_0269_),
    .Q(\execute.alu_mul_div.mul_res[14] ));
 sky130_fd_sc_hd__dfxtp_1 _8039_ (.CLK(i_clk),
    .D(_0270_),
    .Q(\execute.alu_mul_div.mul_res[15] ));
 sky130_fd_sc_hd__dfxtp_1 _8040_ (.CLK(i_clk),
    .D(_0271_),
    .Q(\execute.alu_mul_div.mul_res[0] ));
 sky130_fd_sc_hd__dfxtp_1 _8041_ (.CLK(i_clk),
    .D(_0272_),
    .Q(\execute.alu_mul_div.mul_res[1] ));
 sky130_fd_sc_hd__dfxtp_2 _8042_ (.CLK(i_clk),
    .D(_0273_),
    .Q(\execute.alu_mul_div.mul_res[2] ));
 sky130_fd_sc_hd__dfxtp_2 _8043_ (.CLK(i_clk),
    .D(_0274_),
    .Q(\execute.alu_mul_div.mul_res[3] ));
 sky130_fd_sc_hd__dfxtp_2 _8044_ (.CLK(i_clk),
    .D(_0275_),
    .Q(\execute.alu_mul_div.mul_res[4] ));
 sky130_fd_sc_hd__dfxtp_2 _8045_ (.CLK(i_clk),
    .D(_0276_),
    .Q(\execute.alu_mul_div.mul_res[5] ));
 sky130_fd_sc_hd__dfxtp_2 _8046_ (.CLK(i_clk),
    .D(_0277_),
    .Q(\execute.alu_mul_div.mul_res[6] ));
 sky130_fd_sc_hd__dfxtp_2 _8047_ (.CLK(i_clk),
    .D(_0278_),
    .Q(\execute.alu_mul_div.mul_res[7] ));
 sky130_fd_sc_hd__dfxtp_2 _8048_ (.CLK(i_clk),
    .D(_0279_),
    .Q(\execute.alu_mul_div.mul_res[8] ));
 sky130_fd_sc_hd__dfxtp_2 _8049_ (.CLK(i_clk),
    .D(_0280_),
    .Q(\execute.alu_mul_div.mul_res[9] ));
 sky130_fd_sc_hd__dfxtp_2 _8050_ (.CLK(i_clk),
    .D(_0281_),
    .Q(\execute.alu_mul_div.mul_res[10] ));
 sky130_fd_sc_hd__dfxtp_2 _8051_ (.CLK(i_clk),
    .D(_0282_),
    .Q(\execute.alu_mul_div.mul_res[11] ));
 sky130_fd_sc_hd__dfxtp_2 _8052_ (.CLK(i_clk),
    .D(_0283_),
    .Q(\execute.alu_mul_div.mul_res[12] ));
 sky130_fd_sc_hd__dfxtp_2 _8053_ (.CLK(i_clk),
    .D(_0284_),
    .Q(\execute.alu_mul_div.mul_res[13] ));
 sky130_fd_sc_hd__dfxtp_2 _8054_ (.CLK(i_clk),
    .D(_0285_),
    .Q(\execute.alu_mul_div.mul_res[14] ));
 sky130_fd_sc_hd__dfxtp_1 _8055_ (.CLK(i_clk),
    .D(_0286_),
    .Q(\execute.alu_mul_div.mul_res[15] ));
 sky130_fd_sc_hd__dfxtp_1 _8056_ (.CLK(i_clk),
    .D(_0287_),
    .Q(\execute.alu_mul_div.comp ));
 sky130_fd_sc_hd__dfxtp_1 _8057_ (.CLK(i_clk),
    .D(_0288_),
    .Q(\execute.alu_mul_div.div_cur[0] ));
 sky130_fd_sc_hd__dfxtp_2 _8058_ (.CLK(i_clk),
    .D(_0289_),
    .Q(\execute.alu_mul_div.cbit[0] ));
 sky130_fd_sc_hd__dfxtp_1 _8059_ (.CLK(i_clk),
    .D(_0290_),
    .Q(\execute.irq_en ));
 sky130_fd_sc_hd__dfxtp_4 _8060_ (.CLK(i_clk),
    .D(_0291_),
    .Q(net128));
 sky130_fd_sc_hd__dfxtp_4 _8061_ (.CLK(i_clk),
    .D(_0292_),
    .Q(net135));
 sky130_fd_sc_hd__dfxtp_4 _8062_ (.CLK(i_clk),
    .D(_0293_),
    .Q(net136));
 sky130_fd_sc_hd__dfxtp_4 _8063_ (.CLK(i_clk),
    .D(_0294_),
    .Q(net137));
 sky130_fd_sc_hd__dfxtp_2 _8064_ (.CLK(i_clk),
    .D(_0295_),
    .Q(net138));
 sky130_fd_sc_hd__dfxtp_2 _8065_ (.CLK(i_clk),
    .D(_0296_),
    .Q(net139));
 sky130_fd_sc_hd__dfxtp_2 _8066_ (.CLK(i_clk),
    .D(_0297_),
    .Q(net140));
 sky130_fd_sc_hd__dfxtp_4 _8067_ (.CLK(i_clk),
    .D(_0298_),
    .Q(net141));
 sky130_fd_sc_hd__dfxtp_2 _8068_ (.CLK(i_clk),
    .D(_0299_),
    .Q(net142));
 sky130_fd_sc_hd__dfxtp_4 _8069_ (.CLK(i_clk),
    .D(_0300_),
    .Q(net143));
 sky130_fd_sc_hd__dfxtp_2 _8070_ (.CLK(i_clk),
    .D(_0301_),
    .Q(net129));
 sky130_fd_sc_hd__dfxtp_4 _8071_ (.CLK(i_clk),
    .D(_0302_),
    .Q(net130));
 sky130_fd_sc_hd__dfxtp_2 _8072_ (.CLK(i_clk),
    .D(_0303_),
    .Q(net131));
 sky130_fd_sc_hd__dfxtp_2 _8073_ (.CLK(i_clk),
    .D(_0304_),
    .Q(net132));
 sky130_fd_sc_hd__dfxtp_2 _8074_ (.CLK(i_clk),
    .D(_0305_),
    .Q(net133));
 sky130_fd_sc_hd__dfxtp_4 _8075_ (.CLK(i_clk),
    .D(_0306_),
    .Q(net134));
 sky130_fd_sc_hd__dfxtp_1 _8076_ (.CLK(i_clk),
    .D(_0307_),
    .Q(\execute.rf.reg_outputs[1][0] ));
 sky130_fd_sc_hd__dfxtp_1 _8077_ (.CLK(i_clk),
    .D(_0308_),
    .Q(\execute.rf.reg_outputs[1][1] ));
 sky130_fd_sc_hd__dfxtp_2 _8078_ (.CLK(i_clk),
    .D(_0309_),
    .Q(\execute.rf.reg_outputs[1][2] ));
 sky130_fd_sc_hd__dfxtp_2 _8079_ (.CLK(i_clk),
    .D(_0310_),
    .Q(\execute.rf.reg_outputs[1][3] ));
 sky130_fd_sc_hd__dfxtp_2 _8080_ (.CLK(i_clk),
    .D(_0311_),
    .Q(\execute.rf.reg_outputs[1][4] ));
 sky130_fd_sc_hd__dfxtp_2 _8081_ (.CLK(i_clk),
    .D(_0312_),
    .Q(\execute.rf.reg_outputs[1][5] ));
 sky130_fd_sc_hd__dfxtp_2 _8082_ (.CLK(i_clk),
    .D(_0313_),
    .Q(\execute.rf.reg_outputs[1][6] ));
 sky130_fd_sc_hd__dfxtp_2 _8083_ (.CLK(i_clk),
    .D(_0314_),
    .Q(\execute.rf.reg_outputs[1][7] ));
 sky130_fd_sc_hd__dfxtp_1 _8084_ (.CLK(i_clk),
    .D(_0315_),
    .Q(\execute.rf.reg_outputs[1][8] ));
 sky130_fd_sc_hd__dfxtp_1 _8085_ (.CLK(i_clk),
    .D(_0316_),
    .Q(\execute.rf.reg_outputs[1][9] ));
 sky130_fd_sc_hd__dfxtp_1 _8086_ (.CLK(i_clk),
    .D(_0317_),
    .Q(\execute.rf.reg_outputs[1][10] ));
 sky130_fd_sc_hd__dfxtp_1 _8087_ (.CLK(i_clk),
    .D(_0318_),
    .Q(\execute.rf.reg_outputs[1][11] ));
 sky130_fd_sc_hd__dfxtp_1 _8088_ (.CLK(i_clk),
    .D(_0319_),
    .Q(\execute.rf.reg_outputs[1][12] ));
 sky130_fd_sc_hd__dfxtp_1 _8089_ (.CLK(i_clk),
    .D(_0320_),
    .Q(\execute.rf.reg_outputs[1][13] ));
 sky130_fd_sc_hd__dfxtp_1 _8090_ (.CLK(i_clk),
    .D(_0321_),
    .Q(\execute.rf.reg_outputs[1][14] ));
 sky130_fd_sc_hd__dfxtp_1 _8091_ (.CLK(i_clk),
    .D(_0322_),
    .Q(\execute.rf.reg_outputs[1][15] ));
 sky130_fd_sc_hd__dfxtp_1 _8092_ (.CLK(i_clk),
    .D(_0323_),
    .Q(\execute.rf.reg_outputs[2][0] ));
 sky130_fd_sc_hd__dfxtp_1 _8093_ (.CLK(i_clk),
    .D(_0324_),
    .Q(\execute.rf.reg_outputs[2][1] ));
 sky130_fd_sc_hd__dfxtp_1 _8094_ (.CLK(i_clk),
    .D(_0325_),
    .Q(\execute.rf.reg_outputs[2][2] ));
 sky130_fd_sc_hd__dfxtp_1 _8095_ (.CLK(i_clk),
    .D(_0326_),
    .Q(\execute.rf.reg_outputs[2][3] ));
 sky130_fd_sc_hd__dfxtp_2 _8096_ (.CLK(i_clk),
    .D(_0327_),
    .Q(\execute.rf.reg_outputs[2][4] ));
 sky130_fd_sc_hd__dfxtp_2 _8097_ (.CLK(i_clk),
    .D(_0328_),
    .Q(\execute.rf.reg_outputs[2][5] ));
 sky130_fd_sc_hd__dfxtp_2 _8098_ (.CLK(i_clk),
    .D(_0329_),
    .Q(\execute.rf.reg_outputs[2][6] ));
 sky130_fd_sc_hd__dfxtp_1 _8099_ (.CLK(i_clk),
    .D(_0330_),
    .Q(\execute.rf.reg_outputs[2][7] ));
 sky130_fd_sc_hd__dfxtp_1 _8100_ (.CLK(i_clk),
    .D(_0331_),
    .Q(\execute.rf.reg_outputs[2][8] ));
 sky130_fd_sc_hd__dfxtp_1 _8101_ (.CLK(i_clk),
    .D(_0332_),
    .Q(\execute.rf.reg_outputs[2][9] ));
 sky130_fd_sc_hd__dfxtp_1 _8102_ (.CLK(i_clk),
    .D(_0333_),
    .Q(\execute.rf.reg_outputs[2][10] ));
 sky130_fd_sc_hd__dfxtp_1 _8103_ (.CLK(i_clk),
    .D(_0334_),
    .Q(\execute.rf.reg_outputs[2][11] ));
 sky130_fd_sc_hd__dfxtp_1 _8104_ (.CLK(i_clk),
    .D(_0335_),
    .Q(\execute.rf.reg_outputs[2][12] ));
 sky130_fd_sc_hd__dfxtp_1 _8105_ (.CLK(i_clk),
    .D(_0336_),
    .Q(\execute.rf.reg_outputs[2][13] ));
 sky130_fd_sc_hd__dfxtp_1 _8106_ (.CLK(i_clk),
    .D(_0337_),
    .Q(\execute.rf.reg_outputs[2][14] ));
 sky130_fd_sc_hd__dfxtp_1 _8107_ (.CLK(i_clk),
    .D(_0338_),
    .Q(\execute.rf.reg_outputs[2][15] ));
 sky130_fd_sc_hd__dfxtp_1 _8108_ (.CLK(i_clk),
    .D(_0339_),
    .Q(\execute.rf.reg_outputs[3][0] ));
 sky130_fd_sc_hd__dfxtp_1 _8109_ (.CLK(i_clk),
    .D(_0340_),
    .Q(\execute.rf.reg_outputs[3][1] ));
 sky130_fd_sc_hd__dfxtp_2 _8110_ (.CLK(i_clk),
    .D(_0341_),
    .Q(\execute.rf.reg_outputs[3][2] ));
 sky130_fd_sc_hd__dfxtp_2 _8111_ (.CLK(i_clk),
    .D(_0342_),
    .Q(\execute.rf.reg_outputs[3][3] ));
 sky130_fd_sc_hd__dfxtp_2 _8112_ (.CLK(i_clk),
    .D(_0343_),
    .Q(\execute.rf.reg_outputs[3][4] ));
 sky130_fd_sc_hd__dfxtp_2 _8113_ (.CLK(i_clk),
    .D(_0344_),
    .Q(\execute.rf.reg_outputs[3][5] ));
 sky130_fd_sc_hd__dfxtp_2 _8114_ (.CLK(i_clk),
    .D(_0345_),
    .Q(\execute.rf.reg_outputs[3][6] ));
 sky130_fd_sc_hd__dfxtp_1 _8115_ (.CLK(i_clk),
    .D(_0346_),
    .Q(\execute.rf.reg_outputs[3][7] ));
 sky130_fd_sc_hd__dfxtp_1 _8116_ (.CLK(i_clk),
    .D(_0347_),
    .Q(\execute.rf.reg_outputs[3][8] ));
 sky130_fd_sc_hd__dfxtp_1 _8117_ (.CLK(i_clk),
    .D(_0348_),
    .Q(\execute.rf.reg_outputs[3][9] ));
 sky130_fd_sc_hd__dfxtp_1 _8118_ (.CLK(i_clk),
    .D(_0349_),
    .Q(\execute.rf.reg_outputs[3][10] ));
 sky130_fd_sc_hd__dfxtp_1 _8119_ (.CLK(i_clk),
    .D(_0350_),
    .Q(\execute.rf.reg_outputs[3][11] ));
 sky130_fd_sc_hd__dfxtp_1 _8120_ (.CLK(i_clk),
    .D(_0351_),
    .Q(\execute.rf.reg_outputs[3][12] ));
 sky130_fd_sc_hd__dfxtp_1 _8121_ (.CLK(i_clk),
    .D(_0352_),
    .Q(\execute.rf.reg_outputs[3][13] ));
 sky130_fd_sc_hd__dfxtp_1 _8122_ (.CLK(i_clk),
    .D(_0353_),
    .Q(\execute.rf.reg_outputs[3][14] ));
 sky130_fd_sc_hd__dfxtp_1 _8123_ (.CLK(i_clk),
    .D(_0354_),
    .Q(\execute.rf.reg_outputs[3][15] ));
 sky130_fd_sc_hd__dfxtp_1 _8124_ (.CLK(i_clk),
    .D(_0355_),
    .Q(\execute.rf.reg_outputs[4][0] ));
 sky130_fd_sc_hd__dfxtp_1 _8125_ (.CLK(i_clk),
    .D(_0356_),
    .Q(\execute.rf.reg_outputs[4][1] ));
 sky130_fd_sc_hd__dfxtp_2 _8126_ (.CLK(i_clk),
    .D(_0357_),
    .Q(\execute.rf.reg_outputs[4][2] ));
 sky130_fd_sc_hd__dfxtp_2 _8127_ (.CLK(i_clk),
    .D(_0358_),
    .Q(\execute.rf.reg_outputs[4][3] ));
 sky130_fd_sc_hd__dfxtp_2 _8128_ (.CLK(i_clk),
    .D(_0359_),
    .Q(\execute.rf.reg_outputs[4][4] ));
 sky130_fd_sc_hd__dfxtp_1 _8129_ (.CLK(i_clk),
    .D(_0360_),
    .Q(\execute.rf.reg_outputs[4][5] ));
 sky130_fd_sc_hd__dfxtp_2 _8130_ (.CLK(i_clk),
    .D(_0361_),
    .Q(\execute.rf.reg_outputs[4][6] ));
 sky130_fd_sc_hd__dfxtp_2 _8131_ (.CLK(i_clk),
    .D(_0362_),
    .Q(\execute.rf.reg_outputs[4][7] ));
 sky130_fd_sc_hd__dfxtp_1 _8132_ (.CLK(i_clk),
    .D(_0363_),
    .Q(\execute.rf.reg_outputs[4][8] ));
 sky130_fd_sc_hd__dfxtp_1 _8133_ (.CLK(i_clk),
    .D(_0364_),
    .Q(\execute.rf.reg_outputs[4][9] ));
 sky130_fd_sc_hd__dfxtp_1 _8134_ (.CLK(i_clk),
    .D(_0365_),
    .Q(\execute.rf.reg_outputs[4][10] ));
 sky130_fd_sc_hd__dfxtp_1 _8135_ (.CLK(i_clk),
    .D(_0366_),
    .Q(\execute.rf.reg_outputs[4][11] ));
 sky130_fd_sc_hd__dfxtp_1 _8136_ (.CLK(i_clk),
    .D(_0367_),
    .Q(\execute.rf.reg_outputs[4][12] ));
 sky130_fd_sc_hd__dfxtp_1 _8137_ (.CLK(i_clk),
    .D(_0368_),
    .Q(\execute.rf.reg_outputs[4][13] ));
 sky130_fd_sc_hd__dfxtp_1 _8138_ (.CLK(i_clk),
    .D(_0369_),
    .Q(\execute.rf.reg_outputs[4][14] ));
 sky130_fd_sc_hd__dfxtp_1 _8139_ (.CLK(i_clk),
    .D(_0370_),
    .Q(\execute.rf.reg_outputs[4][15] ));
 sky130_fd_sc_hd__dfxtp_2 _8140_ (.CLK(i_clk),
    .D(_0371_),
    .Q(\execute.rf.reg_outputs[5][0] ));
 sky130_fd_sc_hd__dfxtp_1 _8141_ (.CLK(i_clk),
    .D(_0372_),
    .Q(\execute.rf.reg_outputs[5][1] ));
 sky130_fd_sc_hd__dfxtp_1 _8142_ (.CLK(i_clk),
    .D(_0373_),
    .Q(\execute.rf.reg_outputs[5][2] ));
 sky130_fd_sc_hd__dfxtp_1 _8143_ (.CLK(i_clk),
    .D(_0374_),
    .Q(\execute.rf.reg_outputs[5][3] ));
 sky130_fd_sc_hd__dfxtp_1 _8144_ (.CLK(i_clk),
    .D(_0375_),
    .Q(\execute.rf.reg_outputs[5][4] ));
 sky130_fd_sc_hd__dfxtp_2 _8145_ (.CLK(i_clk),
    .D(_0376_),
    .Q(\execute.rf.reg_outputs[5][5] ));
 sky130_fd_sc_hd__dfxtp_2 _8146_ (.CLK(i_clk),
    .D(_0377_),
    .Q(\execute.rf.reg_outputs[5][6] ));
 sky130_fd_sc_hd__dfxtp_1 _8147_ (.CLK(i_clk),
    .D(_0378_),
    .Q(\execute.rf.reg_outputs[5][7] ));
 sky130_fd_sc_hd__dfxtp_1 _8148_ (.CLK(i_clk),
    .D(_0379_),
    .Q(\execute.rf.reg_outputs[5][8] ));
 sky130_fd_sc_hd__dfxtp_1 _8149_ (.CLK(i_clk),
    .D(_0380_),
    .Q(\execute.rf.reg_outputs[5][9] ));
 sky130_fd_sc_hd__dfxtp_1 _8150_ (.CLK(i_clk),
    .D(_0381_),
    .Q(\execute.rf.reg_outputs[5][10] ));
 sky130_fd_sc_hd__dfxtp_1 _8151_ (.CLK(i_clk),
    .D(_0382_),
    .Q(\execute.rf.reg_outputs[5][11] ));
 sky130_fd_sc_hd__dfxtp_2 _8152_ (.CLK(i_clk),
    .D(_0383_),
    .Q(\execute.rf.reg_outputs[5][12] ));
 sky130_fd_sc_hd__dfxtp_1 _8153_ (.CLK(i_clk),
    .D(_0384_),
    .Q(\execute.rf.reg_outputs[5][13] ));
 sky130_fd_sc_hd__dfxtp_1 _8154_ (.CLK(i_clk),
    .D(_0385_),
    .Q(\execute.rf.reg_outputs[5][14] ));
 sky130_fd_sc_hd__dfxtp_2 _8155_ (.CLK(i_clk),
    .D(_0386_),
    .Q(\execute.rf.reg_outputs[5][15] ));
 sky130_fd_sc_hd__dfxtp_1 _8156_ (.CLK(i_clk),
    .D(_0387_),
    .Q(\execute.rf.reg_outputs[6][0] ));
 sky130_fd_sc_hd__dfxtp_1 _8157_ (.CLK(i_clk),
    .D(_0388_),
    .Q(\execute.rf.reg_outputs[6][1] ));
 sky130_fd_sc_hd__dfxtp_1 _8158_ (.CLK(i_clk),
    .D(_0389_),
    .Q(\execute.rf.reg_outputs[6][2] ));
 sky130_fd_sc_hd__dfxtp_2 _8159_ (.CLK(i_clk),
    .D(_0390_),
    .Q(\execute.rf.reg_outputs[6][3] ));
 sky130_fd_sc_hd__dfxtp_1 _8160_ (.CLK(i_clk),
    .D(_0391_),
    .Q(\execute.rf.reg_outputs[6][4] ));
 sky130_fd_sc_hd__dfxtp_1 _8161_ (.CLK(i_clk),
    .D(_0392_),
    .Q(\execute.rf.reg_outputs[6][5] ));
 sky130_fd_sc_hd__dfxtp_2 _8162_ (.CLK(i_clk),
    .D(_0393_),
    .Q(\execute.rf.reg_outputs[6][6] ));
 sky130_fd_sc_hd__dfxtp_2 _8163_ (.CLK(i_clk),
    .D(_0394_),
    .Q(\execute.rf.reg_outputs[6][7] ));
 sky130_fd_sc_hd__dfxtp_1 _8164_ (.CLK(i_clk),
    .D(_0395_),
    .Q(\execute.rf.reg_outputs[6][8] ));
 sky130_fd_sc_hd__dfxtp_1 _8165_ (.CLK(i_clk),
    .D(_0396_),
    .Q(\execute.rf.reg_outputs[6][9] ));
 sky130_fd_sc_hd__dfxtp_1 _8166_ (.CLK(i_clk),
    .D(_0397_),
    .Q(\execute.rf.reg_outputs[6][10] ));
 sky130_fd_sc_hd__dfxtp_1 _8167_ (.CLK(i_clk),
    .D(_0398_),
    .Q(\execute.rf.reg_outputs[6][11] ));
 sky130_fd_sc_hd__dfxtp_1 _8168_ (.CLK(i_clk),
    .D(_0399_),
    .Q(\execute.rf.reg_outputs[6][12] ));
 sky130_fd_sc_hd__dfxtp_1 _8169_ (.CLK(i_clk),
    .D(_0400_),
    .Q(\execute.rf.reg_outputs[6][13] ));
 sky130_fd_sc_hd__dfxtp_1 _8170_ (.CLK(i_clk),
    .D(_0401_),
    .Q(\execute.rf.reg_outputs[6][14] ));
 sky130_fd_sc_hd__dfxtp_1 _8171_ (.CLK(i_clk),
    .D(_0402_),
    .Q(\execute.rf.reg_outputs[6][15] ));
 sky130_fd_sc_hd__dfxtp_1 _8172_ (.CLK(i_clk),
    .D(_0403_),
    .Q(\execute.rf.reg_outputs[7][0] ));
 sky130_fd_sc_hd__dfxtp_1 _8173_ (.CLK(i_clk),
    .D(_0404_),
    .Q(\execute.rf.reg_outputs[7][1] ));
 sky130_fd_sc_hd__dfxtp_1 _8174_ (.CLK(i_clk),
    .D(_0405_),
    .Q(\execute.rf.reg_outputs[7][2] ));
 sky130_fd_sc_hd__dfxtp_1 _8175_ (.CLK(i_clk),
    .D(_0406_),
    .Q(\execute.rf.reg_outputs[7][3] ));
 sky130_fd_sc_hd__dfxtp_1 _8176_ (.CLK(i_clk),
    .D(_0407_),
    .Q(\execute.rf.reg_outputs[7][4] ));
 sky130_fd_sc_hd__dfxtp_1 _8177_ (.CLK(i_clk),
    .D(_0408_),
    .Q(\execute.rf.reg_outputs[7][5] ));
 sky130_fd_sc_hd__dfxtp_1 _8178_ (.CLK(i_clk),
    .D(_0409_),
    .Q(\execute.rf.reg_outputs[7][6] ));
 sky130_fd_sc_hd__dfxtp_1 _8179_ (.CLK(i_clk),
    .D(_0410_),
    .Q(\execute.rf.reg_outputs[7][7] ));
 sky130_fd_sc_hd__dfxtp_2 _8180_ (.CLK(i_clk),
    .D(_0411_),
    .Q(\execute.rf.reg_outputs[7][8] ));
 sky130_fd_sc_hd__dfxtp_2 _8181_ (.CLK(i_clk),
    .D(_0412_),
    .Q(\execute.rf.reg_outputs[7][9] ));
 sky130_fd_sc_hd__dfxtp_2 _8182_ (.CLK(i_clk),
    .D(_0413_),
    .Q(\execute.rf.reg_outputs[7][10] ));
 sky130_fd_sc_hd__dfxtp_2 _8183_ (.CLK(i_clk),
    .D(_0414_),
    .Q(\execute.rf.reg_outputs[7][11] ));
 sky130_fd_sc_hd__dfxtp_1 _8184_ (.CLK(i_clk),
    .D(_0415_),
    .Q(\execute.rf.reg_outputs[7][12] ));
 sky130_fd_sc_hd__dfxtp_1 _8185_ (.CLK(i_clk),
    .D(_0416_),
    .Q(\execute.rf.reg_outputs[7][13] ));
 sky130_fd_sc_hd__dfxtp_2 _8186_ (.CLK(i_clk),
    .D(_0417_),
    .Q(\execute.rf.reg_outputs[7][14] ));
 sky130_fd_sc_hd__dfxtp_2 _8187_ (.CLK(i_clk),
    .D(_0418_),
    .Q(\execute.rf.reg_outputs[7][15] ));
 sky130_fd_sc_hd__dfxtp_1 _8188_ (.CLK(i_clk),
    .D(_0419_),
    .Q(\execute.hold_valid ));
 sky130_fd_sc_hd__dfxtp_2 _8189_ (.CLK(i_clk),
    .D(_0420_),
    .Q(net195));
 sky130_fd_sc_hd__dfxtp_4 _8190_ (.CLK(i_clk),
    .D(_0013_),
    .Q(\decode.i_flush ));
 sky130_fd_sc_hd__dfxtp_1 _8191_ (.CLK(i_clk),
    .D(_0421_),
    .Q(\execute.o_mem_width ));
 sky130_fd_sc_hd__dfxtp_1 _8192_ (.CLK(i_clk),
    .D(_0422_),
    .Q(\execute.o_mem_access ));
 sky130_fd_sc_hd__dfxtp_4 _8193_ (.CLK(i_clk),
    .D(_0423_),
    .Q(\execute.o_reg_ie[0] ));
 sky130_fd_sc_hd__dfxtp_2 _8194_ (.CLK(i_clk),
    .D(_0424_),
    .Q(\execute.o_reg_ie[1] ));
 sky130_fd_sc_hd__dfxtp_2 _8195_ (.CLK(i_clk),
    .D(_0425_),
    .Q(\execute.o_reg_ie[2] ));
 sky130_fd_sc_hd__dfxtp_2 _8196_ (.CLK(i_clk),
    .D(_0426_),
    .Q(\execute.o_reg_ie[3] ));
 sky130_fd_sc_hd__dfxtp_2 _8197_ (.CLK(i_clk),
    .D(_0427_),
    .Q(\execute.o_reg_ie[4] ));
 sky130_fd_sc_hd__dfxtp_2 _8198_ (.CLK(i_clk),
    .D(_0428_),
    .Q(\execute.o_reg_ie[5] ));
 sky130_fd_sc_hd__dfxtp_2 _8199_ (.CLK(i_clk),
    .D(_0429_),
    .Q(\execute.o_reg_ie[6] ));
 sky130_fd_sc_hd__dfxtp_2 _8200_ (.CLK(i_clk),
    .D(_0430_),
    .Q(\execute.o_reg_ie[7] ));
 sky130_fd_sc_hd__dfxtp_1 _8201_ (.CLK(i_clk),
    .D(_0431_),
    .Q(\execute.o_addr[0] ));
 sky130_fd_sc_hd__dfxtp_1 _8202_ (.CLK(i_clk),
    .D(_0432_),
    .Q(net156));
 sky130_fd_sc_hd__dfxtp_1 _8203_ (.CLK(i_clk),
    .D(_0433_),
    .Q(net163));
 sky130_fd_sc_hd__dfxtp_1 _8204_ (.CLK(i_clk),
    .D(_0434_),
    .Q(net164));
 sky130_fd_sc_hd__dfxtp_1 _8205_ (.CLK(i_clk),
    .D(_0435_),
    .Q(net165));
 sky130_fd_sc_hd__dfxtp_1 _8206_ (.CLK(i_clk),
    .D(_0436_),
    .Q(net166));
 sky130_fd_sc_hd__dfxtp_1 _8207_ (.CLK(i_clk),
    .D(_0437_),
    .Q(net167));
 sky130_fd_sc_hd__dfxtp_1 _8208_ (.CLK(i_clk),
    .D(_0438_),
    .Q(net168));
 sky130_fd_sc_hd__dfxtp_1 _8209_ (.CLK(i_clk),
    .D(_0439_),
    .Q(net169));
 sky130_fd_sc_hd__dfxtp_1 _8210_ (.CLK(i_clk),
    .D(_0440_),
    .Q(net170));
 sky130_fd_sc_hd__dfxtp_1 _8211_ (.CLK(i_clk),
    .D(_0441_),
    .Q(net171));
 sky130_fd_sc_hd__dfxtp_1 _8212_ (.CLK(i_clk),
    .D(_0442_),
    .Q(net157));
 sky130_fd_sc_hd__dfxtp_1 _8213_ (.CLK(i_clk),
    .D(_0443_),
    .Q(net158));
 sky130_fd_sc_hd__dfxtp_1 _8214_ (.CLK(i_clk),
    .D(_0444_),
    .Q(net159));
 sky130_fd_sc_hd__dfxtp_1 _8215_ (.CLK(i_clk),
    .D(_0445_),
    .Q(net160));
 sky130_fd_sc_hd__dfxtp_1 _8216_ (.CLK(i_clk),
    .D(_0446_),
    .Q(net161));
 sky130_fd_sc_hd__dfxtp_1 _8217_ (.CLK(i_clk),
    .D(_0447_),
    .Q(\execute.o_data[0] ));
 sky130_fd_sc_hd__dfxtp_1 _8218_ (.CLK(i_clk),
    .D(_0448_),
    .Q(\execute.o_data[1] ));
 sky130_fd_sc_hd__dfxtp_1 _8219_ (.CLK(i_clk),
    .D(_0449_),
    .Q(\execute.o_data[2] ));
 sky130_fd_sc_hd__dfxtp_1 _8220_ (.CLK(i_clk),
    .D(_0450_),
    .Q(\execute.o_data[3] ));
 sky130_fd_sc_hd__dfxtp_1 _8221_ (.CLK(i_clk),
    .D(_0451_),
    .Q(\execute.o_data[4] ));
 sky130_fd_sc_hd__dfxtp_1 _8222_ (.CLK(i_clk),
    .D(_0452_),
    .Q(\execute.o_data[5] ));
 sky130_fd_sc_hd__dfxtp_1 _8223_ (.CLK(i_clk),
    .D(_0453_),
    .Q(\execute.o_data[6] ));
 sky130_fd_sc_hd__dfxtp_1 _8224_ (.CLK(i_clk),
    .D(_0454_),
    .Q(\execute.o_data[7] ));
 sky130_fd_sc_hd__dfxtp_1 _8225_ (.CLK(i_clk),
    .D(_0455_),
    .Q(\execute.o_data[8] ));
 sky130_fd_sc_hd__dfxtp_1 _8226_ (.CLK(i_clk),
    .D(_0456_),
    .Q(\execute.o_data[9] ));
 sky130_fd_sc_hd__dfxtp_1 _8227_ (.CLK(i_clk),
    .D(_0457_),
    .Q(\execute.o_data[10] ));
 sky130_fd_sc_hd__dfxtp_1 _8228_ (.CLK(i_clk),
    .D(_0458_),
    .Q(\execute.o_data[11] ));
 sky130_fd_sc_hd__dfxtp_1 _8229_ (.CLK(i_clk),
    .D(_0459_),
    .Q(\execute.o_data[12] ));
 sky130_fd_sc_hd__dfxtp_1 _8230_ (.CLK(i_clk),
    .D(_0460_),
    .Q(\execute.o_data[13] ));
 sky130_fd_sc_hd__dfxtp_1 _8231_ (.CLK(i_clk),
    .D(_0461_),
    .Q(\execute.o_data[14] ));
 sky130_fd_sc_hd__dfxtp_1 _8232_ (.CLK(i_clk),
    .D(_0462_),
    .Q(\execute.o_data[15] ));
 sky130_fd_sc_hd__dfxtp_1 _8233_ (.CLK(i_clk),
    .D(_0463_),
    .Q(\execute.o_submit ));
 sky130_fd_sc_hd__dfxtp_1 _8234_ (.CLK(i_clk),
    .D(_0464_),
    .Q(\execute.o_mem_addr_high[0] ));
 sky130_fd_sc_hd__dfxtp_1 _8235_ (.CLK(i_clk),
    .D(_0465_),
    .Q(net172));
 sky130_fd_sc_hd__dfxtp_1 _8236_ (.CLK(i_clk),
    .D(_0466_),
    .Q(net173));
 sky130_fd_sc_hd__dfxtp_1 _8237_ (.CLK(i_clk),
    .D(_0467_),
    .Q(net174));
 sky130_fd_sc_hd__dfxtp_1 _8238_ (.CLK(i_clk),
    .D(_0468_),
    .Q(net175));
 sky130_fd_sc_hd__dfxtp_1 _8239_ (.CLK(i_clk),
    .D(_0469_),
    .Q(net176));
 sky130_fd_sc_hd__dfxtp_1 _8240_ (.CLK(i_clk),
    .D(_0470_),
    .Q(net177));
 sky130_fd_sc_hd__dfxtp_1 _8241_ (.CLK(i_clk),
    .D(_0471_),
    .Q(net178));
 sky130_fd_sc_hd__dfxtp_1 _8242_ (.CLK(i_clk),
    .D(_0472_),
    .Q(net199));
 sky130_fd_sc_hd__dfxtp_1 _8243_ (.CLK(i_clk),
    .D(_0473_),
    .Q(\execute.prev_sys ));
 sky130_fd_sc_hd__dfxtp_1 _8244_ (.CLK(i_clk),
    .D(_0474_),
    .Q(\execute.sreg_irq_flags.i_d[2] ));
 sky130_fd_sc_hd__dfxtp_1 _8245_ (.CLK(i_clk),
    .D(_0475_),
    .Q(\execute.prev_pc_high[0] ));
 sky130_fd_sc_hd__dfxtp_1 _8246_ (.CLK(i_clk),
    .D(_0476_),
    .Q(\execute.prev_pc_high[1] ));
 sky130_fd_sc_hd__dfxtp_1 _8247_ (.CLK(i_clk),
    .D(_0477_),
    .Q(\execute.prev_pc_high[2] ));
 sky130_fd_sc_hd__dfxtp_1 _8248_ (.CLK(i_clk),
    .D(_0478_),
    .Q(\execute.prev_pc_high[3] ));
 sky130_fd_sc_hd__dfxtp_1 _8249_ (.CLK(i_clk),
    .D(_0479_),
    .Q(\execute.prev_pc_high[4] ));
 sky130_fd_sc_hd__dfxtp_1 _8250_ (.CLK(i_clk),
    .D(_0480_),
    .Q(\execute.prev_pc_high[5] ));
 sky130_fd_sc_hd__dfxtp_1 _8251_ (.CLK(i_clk),
    .D(_0481_),
    .Q(\execute.prev_pc_high[6] ));
 sky130_fd_sc_hd__dfxtp_1 _8252_ (.CLK(i_clk),
    .D(_0482_),
    .Q(\execute.prev_pc_high[7] ));
 sky130_fd_sc_hd__dfxtp_1 _8253_ (.CLK(i_clk),
    .D(_0483_),
    .Q(\execute.mem_stage_pc[0] ));
 sky130_fd_sc_hd__dfxtp_1 _8254_ (.CLK(i_clk),
    .D(_0484_),
    .Q(\execute.mem_stage_pc[1] ));
 sky130_fd_sc_hd__dfxtp_1 _8255_ (.CLK(i_clk),
    .D(_0485_),
    .Q(\execute.mem_stage_pc[2] ));
 sky130_fd_sc_hd__dfxtp_1 _8256_ (.CLK(i_clk),
    .D(_0486_),
    .Q(\execute.mem_stage_pc[3] ));
 sky130_fd_sc_hd__dfxtp_1 _8257_ (.CLK(i_clk),
    .D(_0487_),
    .Q(\execute.mem_stage_pc[4] ));
 sky130_fd_sc_hd__dfxtp_1 _8258_ (.CLK(i_clk),
    .D(_0488_),
    .Q(\execute.mem_stage_pc[5] ));
 sky130_fd_sc_hd__dfxtp_1 _8259_ (.CLK(i_clk),
    .D(_0489_),
    .Q(\execute.mem_stage_pc[6] ));
 sky130_fd_sc_hd__dfxtp_1 _8260_ (.CLK(i_clk),
    .D(_0490_),
    .Q(\execute.mem_stage_pc[7] ));
 sky130_fd_sc_hd__dfxtp_1 _8261_ (.CLK(i_clk),
    .D(_0491_),
    .Q(\execute.mem_stage_pc[8] ));
 sky130_fd_sc_hd__dfxtp_1 _8262_ (.CLK(i_clk),
    .D(_0492_),
    .Q(\execute.mem_stage_pc[9] ));
 sky130_fd_sc_hd__dfxtp_1 _8263_ (.CLK(i_clk),
    .D(_0493_),
    .Q(\execute.mem_stage_pc[10] ));
 sky130_fd_sc_hd__dfxtp_1 _8264_ (.CLK(i_clk),
    .D(_0494_),
    .Q(\execute.mem_stage_pc[11] ));
 sky130_fd_sc_hd__dfxtp_1 _8265_ (.CLK(i_clk),
    .D(_0495_),
    .Q(\execute.mem_stage_pc[12] ));
 sky130_fd_sc_hd__dfxtp_1 _8266_ (.CLK(i_clk),
    .D(_0496_),
    .Q(\execute.mem_stage_pc[13] ));
 sky130_fd_sc_hd__dfxtp_1 _8267_ (.CLK(i_clk),
    .D(_0497_),
    .Q(\execute.mem_stage_pc[14] ));
 sky130_fd_sc_hd__dfxtp_1 _8268_ (.CLK(i_clk),
    .D(_0498_),
    .Q(\execute.mem_stage_pc[15] ));
 sky130_fd_sc_hd__dfxtp_1 _8269_ (.CLK(i_clk),
    .D(_0014_),
    .Q(net147));
 sky130_fd_sc_hd__dfxtp_2 _8270_ (.CLK(i_clk),
    .D(_0499_),
    .Q(net144));
 sky130_fd_sc_hd__dfxtp_1 _8271_ (.CLK(i_clk),
    .D(_0500_),
